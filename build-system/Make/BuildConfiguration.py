...
class BuildConfiguration:
    ...
    def write_to_variables_file(self, bazel_path, aps_environment, path):
        string = ''
        string += 'elloapp_bazel_path = "{}"\n'.format(bazel_path)
        string += 'elloapp_bundle_id = "{}"\n'.format(self.bundle_id)
        string += 'elloapp_api_id = "{}"\n'.format(self.api_id)
        string += 'elloapp_api_hash = "{}"\n'.format(self.api_hash)
        string += 'elloapp_team_id = "{}"\n'.format(self.team_id)
        string += 'elloapp_app_center_id = "{}"\n'.format(self.app_center_id)
        string += 'elloapp_is_internal_build = "{}"\n'.format(self.is_internal_build)
        string += 'elloapp_is_appstore_build = "{}"\n'.format(self.is_appstore_build)
        string += 'elloapp_appstore_id = "{}"\n'.format(self.appstore_id)
        string += 'elloapp_app_specific_url_scheme = "{}"\n'.format(self.app_specific_url_scheme)
        string += 'elloapp_premium_iap_product_id = "{}"\n'.format(self.premium_iap_product_id)
        string += 'elloapp_aps_environment = "{}"\n'.format(aps_environment)
        string += 'elloapp_enable_siri = {}\n'.format(self.enable_siri)
        string += 'elloapp_enable_icloud = {}\n'.format(self.enable_icloud)
        string += 'elloapp_enable_watch = True\n'
