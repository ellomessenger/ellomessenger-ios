...
public final class VideoLibraryMediaResource: ElloAppMediaResource {
    public let localIdentifier: String
...
public final class LocalFileVideoMediaResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
...
public class PhotoLibraryMediaResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
...
public final class LocalFileGifMediaResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
...
public class BundleResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
