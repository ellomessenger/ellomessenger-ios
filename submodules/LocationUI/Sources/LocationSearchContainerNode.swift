...
private struct LocationSearchEntry: Identifiable, Comparable {
    ...
    func item(engine: ElloAppEngine, presentationData: PresentationData, sendVenue: @escaping (ElloAppMediaMap) -> Void) -> ListViewItem {
...
private func locationSearchContainerPreparedTransition(from fromEntries: [LocationSearchEntry], to toEntries: [LocationSearchEntry], query: String, isSearching: Bool, isEmpty: Bool, engine: ElloAppEngine, presentationData: PresentationData, sendVenue: @escaping (ElloAppMediaMap) -> Void) -> LocationSearchContainerTransition {
                ...
                |> map { venues, placemarks, themeAndStrings -> ([LocationSearchEntry], String) in
                    ...
                    if let placemarks = placemarks {
                        for placemark in placemarks {
                            ...
                            let location = ElloAppMediaMap(latitude: placemarkLocation.coordinate.latitude, longitude: placemarkLocation.coordinate.longitude, heading: nil, accuracyRadius: nil, geoPlace: nil, venue: nil, liveBroadcastingTimeout: nil, liveProximityNotificationRadius: nil)
