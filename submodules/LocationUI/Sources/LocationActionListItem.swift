...
final class LocationActionListItem: ListViewItem {
    ...
    public init(presentationData: ItemListPresentationData, engine: ElloAppEngine, title: String, subtitle: String, icon: LocationActionListItemIcon, beginTimeAndTimeout: (Double, Double)?, action: @escaping () -> Void, highlighted: @escaping (Bool) -> Void = { _ in }) {
