...
public struct PeerId: Hashable, CustomStringConvertible, Comparable, Codable {
    ...
    public static let notificationsBotPeerID = PeerId(777000)
    public static let aiBotPeerID = PeerId(776999)
    public static let aiPhoenixBotPeerID = PeerId(776996)
    public static let aiBusinessForStudentsBotPeerID = PeerId(776995)
    public static let aiCancerPreventationBotPeerID = PeerId(776994)

    public var isNotificationsBotID: Bool {
        self == Self.notificationsBotPeerID
    }
    
    public var isAIBotID: Bool {
        self == Self.aiBotPeerID
    }
    
    public var isAIPhoenixBotID: Bool {
        self == Self.aiPhoenixBotPeerID
    }
    
    public var isAIBusinessForStudentsBotID: Bool {
        self == Self.aiBusinessForStudentsBotPeerID
    }

    public var isAICancerPreventationBotID: Bool {
        self == Self.aiCancerPreventationBotPeerID
    }

    public var isAIBots: Bool {
        isAIBotID || isAIPhoenixBotID || isAIBusinessForStudentsBotID || isAICancerPreventationBotID
    }
    
    public var isAIImageBot: Bool {
        isAIBotID || isAIPhoenixBotID
    }
