...
final class InstantPageArticleNode: ASDisplayNode, InstantPageNode {
    ...
    init(context: AccountContext, item: InstantPageArticleItem, webPage: ElloAppMediaWebpage, strings: PresentationStrings, theme: InstantPageTheme, contentItems: [InstantPageItem], contentSize: CGSize, cover: ElloAppMediaImage?, url: String, webpageId: MediaId, openUrl: @escaping (InstantPageUrlItem) -> Void) {
        self.item = item
        self.url = url
