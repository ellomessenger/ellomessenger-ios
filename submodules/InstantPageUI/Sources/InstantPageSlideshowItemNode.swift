...
private final class InstantPageSlideshowPagerNode: ASDisplayNode, UIScrollViewDelegate {
    ...
    init(context: AccountContext, sourcePeerType: MediaAutoDownloadPeerType, theme: InstantPageTheme, webPage: ElloAppMediaWebpage, openMedia: @escaping (InstantPageMedia) -> Void, longPressMedia: @escaping (InstantPageMedia) -> Void, pageGap: CGFloat = 0.0) {
    ...
    private func makeNodeForItem(at index: Int) -> InstantPageSlideshowItemNode {
        ...
        if let _ = media.media as? ElloAppMediaImage {
        ...
        } else if let _ = media.media as? ElloAppMediaFile {
...
final class InstantPageSlideshowNode: ASDisplayNode, InstantPageNode {
    ...
    init(context: AccountContext, sourcePeerType: MediaAutoDownloadPeerType, theme: InstantPageTheme, webPage: ElloAppMediaWebpage, medias: [InstantPageMedia], openMedia: @escaping (InstantPageMedia) -> Void, longPressMedia: @escaping (InstantPageMedia) -> Void) {
        self.medias = medias
