...
public func instantPageAndAnchor(message: Message) -> (ElloAppMediaWebpage, String?)? {
...
public final class InstantPageController: ViewController {
    ...
    public init(context: AccountContext, webPage: ElloAppMediaWebpage, sourcePeerType: MediaAutoDownloadPeerType, anchor: String? = nil) {
