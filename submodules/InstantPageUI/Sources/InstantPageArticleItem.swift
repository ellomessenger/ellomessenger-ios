...
final class InstantPageArticleItem: InstantPageItem {
    ...
    let cover: ElloAppMediaImage?
    let url: String
    let webpageId: MediaId
    let rtl: Bool
    let hasRTL: Bool
    
    init(frame: CGRect, webPage: ElloAppMediaWebpage, contentItems: [InstantPageItem], contentSize: CGSize, cover: ElloAppMediaImage?, url: String, webpageId: MediaId, rtl: Bool, hasRTL: Bool) {
        self.frame = frame
...
func layoutArticleItem(theme: InstantPageTheme, webPage: ElloAppMediaWebpage, title: NSAttributedString, description: NSAttributedString, cover: ElloAppMediaImage?, url: String, webpageId: MediaId, boundingWidth: CGFloat, rtl: Bool) -> InstantPageArticleItem {
