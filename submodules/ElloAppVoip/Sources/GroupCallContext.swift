...
final class NetworkBroadcastPartSource: BroadcastPartSource {
    ...
    init(queue: Queue, engine: ElloAppEngine, callId: Int64, accessHash: Int64, isExternalStream: Bool) {
        self.queue = queue
        self.engine = engine
        self.callId = callId
...
public final class OngoingGroupCallContext {
    public struct AudioStreamData {
        public var engine: ElloAppEngine
        public var callId: Int64
        public var accessHash: Int64
        public var isExternalStream: Bool
        
        public init(engine: ElloAppEngine, callId: Int64, accessHash: Int64, isExternalStream: Bool) {
            self.engine = engine
            self.callId = callId
            self.accessHash = accessHash
            self.isExternalStream = isExternalStream
