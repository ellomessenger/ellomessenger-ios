...
private final class PeerChannelMemberCategoriesContextsManagerImpl {
    ...
    func getContext(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, key: PeerChannelMemberContextKey, requestUpdate: Bool, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl) {
    ...
    func recentOnline(account: Account, accountPeerId: PeerId, peerId: PeerId, updated: @escaping (Int32) -> Void) -> Disposable {
        ...
        if let current = self.onlineContexts[peerId] {
            ...
            let signal = (
                ElloAppEngine(account: account).peers.chatOnlineMembers(peerId: peerId)
                |> then(
                    .complete()
...
public final class PeerChannelMemberCategoriesContextsManager {
    ...
    private func getContext(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, key: PeerChannelMemberContextKey, requestUpdate: Bool, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
        assert(Queue.mainQueue().isCurrent())
    ...
    public func recent(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, requestUpdate: Bool = true, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func mentions(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, threadMessageId: MessageId?, searchQuery: String? = nil, requestUpdate: Bool = true, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
        let key: PeerChannelMemberContextKey = .mentions(threadId: threadMessageId, query: searchQuery)
        return self.getContext(engine: engine, postbox: postbox, network: network, accountPeerId: accountPeerId, peerId: peerId, key: key, requestUpdate: requestUpdate, updated: updated)
    }
    
    public func admins(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func contacts(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func bots(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func restricted(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func banned(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func restrictedAndBanned(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, searchQuery: String? = nil, updated: @escaping (ChannelMemberListState) -> Void) -> (Disposable, PeerChannelMemberCategoryControl?) {
    ...
    public func updateMemberBannedRights(engine: ElloAppEngine, peerId: PeerId, memberId: PeerId, bannedRights: ElloAppChatBannedRights?) -> Signal<Void, NoError> {
    ...
    public func updateMemberAdminRights(engine: ElloAppEngine, peerId: PeerId, memberId: PeerId, adminRights: ElloAppChatAdminRights?, rank: String?) -> Signal<Void, UpdateChannelAdminRightsError> {
    ...
    public func transferOwnership(engine: ElloAppEngine, peerId: PeerId, memberId: PeerId, password: String) -> Signal<Void, ChannelOwnershipTransferError> {
    ...
    public func join(engine: ElloAppEngine, peerId: PeerId, hash: String?) -> Signal<Never, JoinChannelError> {
    ...
    public func addMember(engine: ElloAppEngine, peerId: PeerId, memberId: PeerId) -> Signal<Never, AddChannelMemberError> {
    ...
    public func addMembers(engine: ElloAppEngine, peerId: PeerId, memberIds: [PeerId]) -> Signal<Void, AddChannelMemberError> {
    ...
    public func recentOnlineSmall(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId) -> Signal<Int32, NoError> {
        return Signal { [weak self] subscriber in
            ...
            let disposableAndControl = self?.recent(engine: engine, postbox: postbox, network: network, accountPeerId: accountPeerId, peerId: peerId, updated: { state in
                ...
                if previousIds != updatedIds {
                    ...
                    statusesDisposable.set((engine.data.subscribe(EngineDataMap(
                        updatedIds.map(ElloAppEngine.EngineData.Item.Peer.Presence.init)
                    ))
