...
private final class ChannelMemberSingleCategoryListContext: ChannelMemberCategoryListContext {
    ...
    init(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, category: ChannelMemberListCategory) {
        self.engine = engine
...
private final class ChannelMemberMultiCategoryListContext: ChannelMemberCategoryListContext {
    ...
    init(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, categories: [ChannelMemberListCategory]) {
...
final class PeerChannelMemberCategoriesContext {
    ...
    init(engine: ElloAppEngine, postbox: Postbox, network: Network, accountPeerId: PeerId, peerId: PeerId, becameEmpty: @escaping (Bool) -> Void) {
        self.engine = engine
        self.postbox = postbox
        self.network = network
        self.accountPeerId = accountPeerId
