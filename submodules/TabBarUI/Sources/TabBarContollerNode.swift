...
final class TabBarControllerNode: ASDisplayNode {
    ...
    init(theme: TabBarControllerTheme,
         ...
         contextAction: @escaping (Int, ContextExtractedContentContainingNode, ContextGesture) -> Void,
         swipeAction: @escaping (Int, TabBarItemSwipeDirection) -> Void,
         toolbarActionSelected: @escaping (ToolbarActionOption) -> Void,
         disabledPressed: @escaping () -> Void) {
        self.theme = theme
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, toolbar: Toolbar?, transition: ContainedViewLayoutTransition) {
        ...
        self.tabBarNode.updateLayout(size: layout.size,
        ...
        if let toolbar = toolbar {
            if let toolbarNode = self.toolbarNode {
                ...
                toolbarNode.updateLayout(size: tabBarFrame.size,
                                         leftInset: layout.safeInsets.left,
                                         rightInset: layout.safeInsets.right,
                                         additionalSideInsets: layout.additionalInsets,
                                         bottomInset: bottomInset,
