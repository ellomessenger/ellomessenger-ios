...
public final class ItemListVenueItem: ListViewItem, ItemListItem {
    ...
    let engine: ElloAppEngine
    let venue: ElloAppMediaMap?
    let title: String?
    let subtitle: String?
    ...
    public init(presentationData: ItemListPresentationData, engine: ElloAppEngine, venue: ElloAppMediaMap?, title: String? = nil, subtitle: String? = nil, sectionId: ItemListSectionId = 0, style: ItemListStyle, action: (() -> Void)?, infoAction: (() -> Void)? = nil, header: ListViewItemHeader? = nil) {
