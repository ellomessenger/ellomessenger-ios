...
class AlertViewController {
    static func createAlertControllerWithImage(title: String?, message: String?, preferredStyle: UIAlertController.Style, actions: [UIAlertAction], image: UIImage?) -> UIAlertController {
        let alertController = UIAlertController(title: title, message: message, preferredStyle: preferredStyle)
        alertController.setBackgroundColor(color: .lightGray)
    ...
    static func createAlertControllerWithTopImage(title: String?, message: String?, preferredStyle: UIAlertController.Style, actions: [UIAlertAction], image: UIImage?) -> UIAlertController {
