...
public func peerAllowedReactionListController(
    ...
    actionsDisposable.add((combineLatest(context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.AllowedReactions(id: peerId)), context.engine.stickers.availableReactions() |> take(1))
    ...
    controller.willDisappear = { _ in
        let _ = (combineLatest(
            context.engine.data.get(
                ...
                ElloAppEngine.EngineData.Item.Peer.AllowedReactions(id: peerId)
            ),
