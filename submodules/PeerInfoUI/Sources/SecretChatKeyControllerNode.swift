...
final class SecretChatKeyControllerNode: ViewControllerTracingNode {
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        let linkRange = (infoString.string as NSString).range(of: "elloapp.com")
        if linkRange.location != NSNotFound {
            infoText.addAttributes([.foregroundColor: self.presentationData.theme.list.itemAccentColor, NSAttributedString.Key(rawValue: ElloAppTextAttributes.URL): "https://www.elloapp.net/faq#secret-chats"], range: linkRange)
        }
