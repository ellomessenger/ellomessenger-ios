...
private func getUserPeer(engine: ElloAppEngine, peerId: EnginePeer.Id) -> Signal<(EnginePeer?, EnginePeer.StatusSettings?), NoError> {
    ...
    |> mapToSignal { peer -> Signal<(EnginePeer?, EnginePeer.StatusSettings?), NoError> in
        ...
        return engine.data.get(ElloAppEngine.EngineData.Item.Peer.StatusSettings(id: peer.id))
...
public func openAddPersonContactImpl(context: AccountContext, 
    ...
    |> deliverOnMainQueue).start(next: { peer, statusSettings in
        ...
        pushController(deviceContactInfoController(context: context,
                                                   updatedPresentationData: updatedPresentationData,
                                                   subject: .create(peer: user,
