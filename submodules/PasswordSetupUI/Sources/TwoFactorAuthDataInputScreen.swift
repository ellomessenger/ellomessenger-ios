...
public final class TwoFactorDataInputScreen: ViewController {
    ...
    public init(sharedContext: SharedAccountContext, engine: SomeElloAppEngine, mode: TwoFactorDataInputMode, stateUpdated: @escaping (SetupTwoStepVerificationStateUpdate) -> Void, presentation: ViewControllerNavigationPresentation = .modalInLargeLayout) {
