...
public final class TwoFactorAuthSplashScreen: ViewController {
    ...
    public init(sharedContext: SharedAccountContext, engine: SomeElloAppEngine, mode: TwoFactorAuthSplashMode, presentation: ViewControllerNavigationPresentation = .modalInLargeLayout) {
