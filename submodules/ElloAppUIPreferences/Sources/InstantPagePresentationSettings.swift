...
public func updateInstantPagePresentationSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (InstantPagePresentationSettings) -> InstantPagePresentationSettings) -> Signal<Void, NoError> {
