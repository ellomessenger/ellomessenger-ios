...
public enum PresentationBuiltinThemeReference: Int32 {
    ...
    public init(baseTheme: ElloAppBaseTheme) {
        switch baseTheme {
            case .classic:
                self = .dayClassic
            case .day:
...
//                self = .nightAccent
    ...
    public var baseTheme: ElloAppBaseTheme {
        switch self {
            case .dayClassic:
                return .classic
            case .day:
...
public struct PresentationLocalTheme: PostboxCoding, Equatable {
    ...
    public let resolvedWallpaper: ElloAppWallpaper?
    
    public init(title: String, resource: LocalFileMediaResource, resolvedWallpaper: ElloAppWallpaper?) {
        self.title = title
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.resolvedWallpaper = decoder.decode(ElloAppWallpaperNativeCodable.self, forKey: "wallpaper")?.value
    }
    ...
    public func encode(_ encoder: PostboxEncoder) {
        ...
        if let resolvedWallpaper = self.resolvedWallpaper {
            encoder.encode(ElloAppWallpaperNativeCodable(resolvedWallpaper), forKey: "wallpaper")
        } else {
...
public struct PresentationCloudTheme: Codable, Equatable {
    public let theme: ElloAppTheme
    public let resolvedWallpaper: ElloAppWallpaper?
    public let creatorAccountId: AccountRecordId?
    
    public init(theme: ElloAppTheme, resolvedWallpaper: ElloAppWallpaper?, creatorAccountId: AccountRecordId?) {
        self.theme = theme
        self.resolvedWallpaper = resolvedWallpaper
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.theme = (try container.decode(ElloAppThemeNativeCodable.self, forKey: "theme")).value
        self.resolvedWallpaper = (try container.decodeIfPresent(ElloAppWallpaperNativeCodable.self, forKey: "wallpaper"))?.value
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(ElloAppThemeNativeCodable(self.theme), forKey: "theme")
        try container.encodeIfPresent(self.resolvedWallpaper.flatMap(ElloAppWallpaperNativeCodable.init), forKey: "wallpaper")
...
public struct PresentationThemeAccentColor: PostboxCoding, Equatable {
    ...
    public init(index: Int32, baseColor: PresentationThemeBaseColor, accentColor: UInt32? = nil, bubbleColors: [UInt32] = [], wallpaper: ElloAppWallpaper? = nil) {
        self.index = index
        self.baseColor = baseColor
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.wallpaper = decoder.decode(ElloAppWallpaperNativeCodable.self, forKey: "w")?.value
    ...
    public func encode(_ encoder: PostboxEncoder) {
        ...
        if let wallpaper = self.wallpaper {
            encoder.encode(ElloAppWallpaperNativeCodable(wallpaper), forKey: "w")
        } else {
    ...
    public func colorFor(baseTheme: ElloAppBaseTheme) -> UIColor {
        if let value = self.accentColor {
            return UIColor(rgb: UInt32(bitPattern: value))
        } else {
    ...
    public func withUpdatedWallpaper(_ wallpaper: ElloAppWallpaper?) -> PresentationThemeAccentColor {
...
public struct PresentationThemeSettings: Codable {
    ...
    public var theme: PresentationThemeReference
    public var themePreferredBaseTheme: [Int64: ElloAppBaseTheme]
    public var themeSpecificAccentColors: [Int64: PresentationThemeAccentColor]
    public var themeSpecificChatWallpapers: [Int64: ElloAppWallpaper]
    ...
    private func wallpaperResources(_ wallpaper: ElloAppWallpaper) -> [MediaResourceId] {
        switch wallpaper {
    ...
    public init(theme: PresentationThemeReference, themePreferredBaseTheme: [Int64: ElloAppBaseTheme], themeSpecificAccentColors: [Int64: PresentationThemeAccentColor], themeSpecificChatWallpapers: [Int64: ElloAppWallpaper], useSystemFont: Bool, fontSize: PresentationFontSize, listsFontSize: PresentationFontSize, chatBubbleSettings: PresentationChatBubbleSettings, automaticThemeSwitchSetting: AutomaticThemeSwitchSetting, largeEmoji: Bool, reduceMotion: Bool) {
        self.theme = theme
    ...
    public init(from decoder: Decoder) throws {
        ...
        var mappedThemePreferredBaseTheme: [Int64: ElloAppBaseTheme] = [:]
        ...
        for (key, value) in themePreferredBaseThemeDict {
            if let baseTheme = ElloAppBaseTheme(rawValue: Int32(clamping: value)) {
                mappedThemePreferredBaseTheme[key] = baseTheme
            }
        }
        self.themePreferredBaseTheme = mappedThemePreferredBaseTheme

        let themeSpecificChatWallpapersDict = try container.decode([DictionaryKey: ElloAppWallpaperNativeCodable].self, forKey: "themeSpecificChatWallpapers")
        var mappedThemeSpecificChatWallpapers: [Int64: ElloAppWallpaper] = [:]
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        var mappedThemeSpecificChatWallpapers: [DictionaryKey: ElloAppWallpaperNativeCodable] = [:]
        for (key, value) in self.themeSpecificChatWallpapers {
            mappedThemeSpecificChatWallpapers[DictionaryKey(key)] = ElloAppWallpaperNativeCodable(value)
        }
    ...
    public func withUpdatedThemePreferredBaseTheme(_ themePreferredBaseTheme: [Int64: ElloAppBaseTheme]) -> PresentationThemeSettings {
    ...
    public func withUpdatedThemeSpecificChatWallpapers(_ themeSpecificChatWallpapers: [Int64: ElloAppWallpaper]) -> PresentationThemeSettings {
...
public func updatePresentationThemeSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (PresentationThemeSettings) -> PresentationThemeSettings) -> Signal<Void, NoError> {
