...
public func updateWebBrowserSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (WebBrowserSettings) -> WebBrowserSettings) -> Signal<Void, NoError> {
