...
public func updateWebSearchSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (WebSearchSettings) -> WebSearchSettings) -> Signal<Void, NoError> {
