...
public func updateTranslationSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (TranslationSettings) -> TranslationSettings) -> Signal<Void, NoError> {
