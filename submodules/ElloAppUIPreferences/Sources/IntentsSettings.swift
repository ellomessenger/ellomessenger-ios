...
public func updateIntentsSettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (IntentsSettings) -> IntentsSettings) -> Signal<(IntentsSettings?, IntentsSettings?), NoError> {
