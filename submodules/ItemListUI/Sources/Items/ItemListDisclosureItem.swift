...
public class ItemListDisclosureItem: ListViewItem, ItemListItem {
    ...
    public init(presentationData: ItemListPresentationData,
        ...
        self.titleLeftInset = titleLeftInset
    ...
    public func asyncLayout() -> (_ item: ItemListDisclosureItem, _ params: ListViewItemLayoutParams, _ insets: ItemListNeighbors) -> (ListViewItemNodeLayout, () -> Void) {
        ...
        return { item, params, neighbors in
            ...
            if currentItem?.presentationData.theme !== item.presentationData.theme {
                ...
                if item.disclosureStyle == .arrowDown {
                    updateArrowImage = PresentationResourcesItemList.downArrowImage(item.presentationData.theme)
                } else {
            ...
            return (ListViewItemNodeLayout(contentSize: contentSize, insets: insets), { [weak self] in
                if let strongSelf = self {
                    ...
                    let titleFrame = CGRect(origin: CGPoint(x: item.titleLeftInset ?? leftInset, y: 11.0), size: titleLayout.size)
