...
public func chatMapSnapshotData(engine: ElloAppEngine, resource: MapSnapshotMediaResource) -> Signal<Data?, NoError> {
...
public func chatMapSnapshotImage(engine: ElloAppEngine, resource: MapSnapshotMediaResource) -> Signal<(TransformImageArguments) -> DrawingContext?, NoError> {
