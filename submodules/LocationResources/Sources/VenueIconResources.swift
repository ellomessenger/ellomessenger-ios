...
private func fetchVenueIconResource(engine: ElloAppEngine, resource: VenueIconResource) -> Signal<EngineMediaResource.Fetch.Result, EngineMediaResource.Fetch.Error> {
...
private func venueIconData(engine: ElloAppEngine, resource: VenueIconResource) -> Signal<Data?, NoError> {
...
public func venueIcon(engine: ElloAppEngine, type: String, background: Bool) -> Signal<(TransformImageArguments) -> DrawingContext?, NoError> {
