...
func resourceFromLegacyImageUrl(_ fileRef: String) -> ElloAppMediaResource? {
    if fileRef.isEmpty {
        return nil
    }
...
func pathAndResourceFromEncryptedFileUrl(basePath: String, url: String, type: EncryptedFileType) -> (String, ElloAppMediaResource)? {
    let cache = TGCache(cachesPath: basePath + "/Caches")!
