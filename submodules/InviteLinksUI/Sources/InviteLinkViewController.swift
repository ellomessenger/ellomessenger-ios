                ...
                self.disposable = (combineLatest(
                    ...
                    if let strongSelf = self {
                        ...
                        if requestsState.importers.isEmpty && requestsState.isLoadingMore {
                            ...
                            loading = true
                            let fakeUser = ElloAppUser(id: EnginePeer.Id(namespace: .max, id: EnginePeer.Id.Id._internalFromInt64Value(0)), accessHash: nil, firstName: "", lastName: "", username: nil, phone: nil, photo: [], botInfo: nil, email: nil, country: nil, gender: nil, birthday: nil, restrictionInfo: nil, flags: [], emojiStatus: nil, isBusiness:  false, isPublic: false, botDescription: nil)
                            for i in 0 ..< count {
