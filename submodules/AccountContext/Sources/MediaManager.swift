...
public func peerMessageMediaPlayerType(_ message: Message) -> MediaManagerPlayerType? {
    func extractFileMedia(_ message: Message) -> ElloAppMediaFile? {
...
public protocol MediaManager: AnyObject {
    ...
    func audioRecorder(beginWithTone: Bool, applicationBindings: ElloAppApplicationBindings, beganWithTone: @escaping (Bool) -> Void) -> Signal<ManagedAudioRecorder?, NoError>
}
