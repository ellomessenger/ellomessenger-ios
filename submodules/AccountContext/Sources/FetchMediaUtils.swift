...
public func cancelFreeMediaFileInteractiveFetch(account: Account, file: ElloAppMediaFile) {
    account.postbox.mediaBox.cancelInteractiveResourceFetch(file.resource)
}

private func fetchCategoryForFile(_ file: ElloAppMediaFile) -> FetchManagerCategory {
...
public func messageMediaFileInteractiveFetched(context: AccountContext, message: Message, file: ElloAppMediaFile, userInitiated: Bool) -> Signal<Void, NoError> {
...
public func messageMediaFileInteractiveFetched(fetchManager: FetchManager, messageId: MessageId, messageReference: MessageReference, file: ElloAppMediaFile, ranges: RangeSet<Int64> = RangeSet<Int64>(0 ..< Int64.max), userInitiated: Bool, priority: FetchManagerPriority) -> Signal<Void, NoError> {
...
public func messageMediaFileCancelInteractiveFetch(context: AccountContext, messageId: MessageId, file: ElloAppMediaFile) {
...
public func messageMediaImageInteractiveFetched(context: AccountContext, message: Message, image: ElloAppMediaImage, resource: MediaResource, range: Range<Int64>? = nil, userInitiated: Bool = true, storeToDownloadsPeerType: MediaAutoDownloadPeerType?) -> Signal<Void, NoError> {
...
public func messageMediaImageInteractiveFetched(fetchManager: FetchManager, messageId: MessageId, messageReference: MessageReference, image: ElloAppMediaImage, resource: MediaResource, range: Range<Int64>? = nil, userInitiated: Bool, priority: FetchManagerPriority, storeToDownloadsPeerType: MediaAutoDownloadPeerType?) -> Signal<Void, NoError> {
...
public func messageMediaImageCancelInteractiveFetch(context: AccountContext, messageId: MessageId, image: ElloAppMediaImage, resource: MediaResource) {
...
public func messageMediaFileStatus(context: AccountContext, messageId: MessageId, file: ElloAppMediaFile, adjustForVideoThumbnail: Bool = false) -> Signal<MediaResourceStatus, NoError> {
...
public func messageMediaImageStatus(context: AccountContext, messageId: MessageId, image: ElloAppMediaImage) -> Signal<MediaResourceStatus, NoError> {
