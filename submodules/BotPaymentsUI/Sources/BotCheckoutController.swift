...
public final class BotCheckoutController: ViewController {
    public final class InputData {
        ...
        public static func fetch(context: AccountContext, source: BotPaymentInvoiceSource) -> Signal<InputData, FetchError> {
            ...
            |> mapToSignal { paymentForm -> Signal<InputData, FetchError> in
                return context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.Peer(id: paymentForm.paymentBotId))
    ...
    private let invoice: ElloAppMediaInvoice
    ...
    public init(context: AccountContext, invoice: ElloAppMediaInvoice, source: BotPaymentInvoiceSource, inputData: Promise<BotCheckoutController.InputData?>, completed: @escaping (String, EngineMessage.Id?) -> Void, pending: @escaping () -> Void = {}, cancelled: @escaping () -> Void = {}, failed: @escaping () -> Void = {}) {
