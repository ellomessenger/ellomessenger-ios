...
private final class WebAppAlertContentNode: AlertContentNode {
    ...
    private let peerIcon: ElloAppMediaFile?
    ...
    init(account: Account, theme: AlertControllerTheme, ptheme: PresentationTheme, strings: PresentationStrings, peerName: String, icons: [AttachMenuBots.Bot.IconName: ElloAppMediaFile], actions: [TextAlertAction]) {
...
public func addWebAppToAttachmentController(context: AccountContext, peerName: String, icons: [AttachMenuBots.Bot.IconName: ElloAppMediaFile], completion: @escaping () -> Void) -> AlertController {
