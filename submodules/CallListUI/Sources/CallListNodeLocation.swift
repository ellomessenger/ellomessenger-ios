...
func callListViewForLocationAndType(locationAndType: CallListNodeLocationAndType, engine: ElloAppEngine) -> Signal<(CallListNodeViewUpdate, EngineCallList.Scope), NoError> {
