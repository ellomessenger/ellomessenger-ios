...
public final class CallListController: ElloAppBaseController {
    ...
    public init(context: AccountContext, mode: CallListControllerMode, isPlaceholder: Bool = false) {
...
//            } else {
            if isPlaceholder {
                icon = UIImage(bundleImageName: "Chat List/Tabs/IconFeed")
            } else {
                icon = UIImage(bundleImageName: "Chat List/Tabs/IconCalls")
            }
            
            self.tabBarItem.title = PresentationTheme.isTabbarTitleShown ? ( isPlaceholder ? self.presentationData.strings.Feed_TabTitle : self.presentationData.strings.Calls_TabTitle ) : ""
...
//            }
    ...
    private func updateThemeAndStrings() {
        ...
        self.tabBarItem.title = PresentationTheme.isTabbarTitleShown ? ( self.isPlaceholder ? self.presentationData.strings.Feed_TabTitle : self.presentationData.strings.Calls_TabTitle ) : ""
//        if !self.presentationData.reduceMotion {
//            self.tabBarItem.animationName = "TabCalls"
//        } else {
...
//        }
    ...
    override public func loadDisplayNode() {
        self.displayNode = CallListControllerNode(controller: self, context: self.context, mode: self.mode, presentationData: self.presentationData, isPlaceholder: self.isPlaceholder, call: { [weak self] peerId, isVideo in
            if let strongSelf = self {
...
//            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Context Menu/AddUser"), color: theme.contextMenu.badgeFillColor)
