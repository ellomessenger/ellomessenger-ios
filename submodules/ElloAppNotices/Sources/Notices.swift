...
public struct ApplicationSpecificNotice {
    ...
    public static func setIrrelevantPeerGeoReport(engine: ElloAppEngine, peerId: PeerId) -> Signal<Never, NoError> {
    ...
    public static func getBotPaymentLiability(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Bool, NoError> {
    ...
    public static func setBotPaymentLiability(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Void, NoError> {
    ...
    public static func getBotGameNotice(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setBotGameNotice(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getInlineBotLocationRequest(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Int32?, NoError> {
    ...
    public static func inlineBotLocationRequestStatus(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Bool, NoError> {
    ...
    public static func updateInlineBotLocationRequestState(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId, timestamp: Int32) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setInlineBotLocationRequest(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId, value: Int32) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getSecretChatInlineBotUsage(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setSecretChatInlineBotUsage(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func setSecretChatInlineBotUsage(transaction: AccountManagerModifier<ElloAppAccountManagerTypes>) {
        if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
            transaction.setNotice(ApplicationSpecificNoticeKeys.secretChatInlineBotUsage(), entry)
        }
    }
    
    public static func getSecretChatLinkPreviews(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool?, NoError> {
        return accountManager.transaction { transaction -> Bool? in
    ...
    public static func setSecretChatLinkPreviews(accountManager: AccountManager<ElloAppAccountManagerTypes>, value: Bool) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func setSecretChatLinkPreviews(transaction: AccountManagerModifier<ElloAppAccountManagerTypes>, value: Bool) {
        if let entry = CodableEntry(ApplicationSpecificVariantNotice(value: value)) {
            transaction.setNotice(ApplicationSpecificNoticeKeys.secretChatLinkPreviews(), entry)
        }
    }
    ...
    public static func getChatMediaMediaRecordingTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementChatMediaMediaRecordingTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getArchiveChatTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementArchiveChatTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1) -> Signal<Int, NoError> {
    ...
    public static func incrementChatFolderTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
    ...
    public static func setArchiveIntroDismissed(transaction: AccountManagerModifier<ElloAppAccountManagerTypes>, value: Bool) {
        if let entry = CodableEntry(ApplicationSpecificVariantNotice(value: value)) {
    ...
    public static func getProfileCallTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementProfileCallTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.profileCallTips())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getSetPublicChannelLink(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.profileCallTips())?.get(ApplicationSpecificCounterNotice.self) {
    ...
    public static func markAsSeenSetPublicChannelLink(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getProxyAdsAcknowledgment(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setProxyAdsAcknowledgment(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getPsaAcknowledgment(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setPsaAcknowledgment(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getPasscodeLockTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setPasscodeLockTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func setPermissionWarning(accountManager: AccountManager<ElloAppAccountManagerTypes>, permission: PermissionKind, value: Int32) {
    ...
    public static func getVolumeButtonToUnmute(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setVolumeButtonToUnmute(accountManager: AccountManager<ElloAppAccountManagerTypes>) {
        let _ = accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getCallsTabTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementCallsTabTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.callsTabTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func setCallsTabTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
                transaction.setNotice(ApplicationSpecificNoticeKeys.callsTabTip(), entry)
            }
    ...
    public static func getChatMessageSearchResultsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementChatMessageSearchResultsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatMessageSearchResultsTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getChatMessageOptionsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementChatMessageOptionsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatMessageOptionsTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getChatTextSelectionTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementChatTextSelectionTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatTextSelectionTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getMessageViewsPrivacyTips(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementMessageViewsPrivacyTips(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.messageViewsPrivacyTips())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getThemeChangeTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func markThemeChangeTipAsSeen(accountManager: AccountManager<ElloAppAccountManagerTypes>) {
        let _ = accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getLocationProximityAlertTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatMessageOptionsTip())?.get(ApplicationSpecificCounterNotice.self) {
                return value.value
            } else {
    ...
    public static func incrementLocationProximityAlertTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatMessageOptionsTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getNextChatSuggestionTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementNextChatSuggestionTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.nextChatSuggestionTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getSharedMediaScrollingTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementSharedMediaScrollingTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.sharedMediaScrollingTooltip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getSharedMediaFastScrollingTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementSharedMediaFastScrollingTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.sharedMediaFastScrollingTooltip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getEmojiTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementEmojiTooltip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int32 = 1) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.emojiTooltip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func dismissedTrendingStickerPacks(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<[Int64]?, NoError> {
    ...
    public static func setDismissedTrendingStickerPacks(accountManager: AccountManager<ElloAppAccountManagerTypes>, values: [Int64]) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getChatSpecificThemeLightPreviewTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<(Int32, Int32), NoError> {
    ...
    public static func incrementChatSpecificThemeLightPreviewTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1, timestamp: Int32) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatSpecificThemeLightPreviewTip())?.get(ApplicationSpecificTimestampAndCounterNotice.self) {
    ...
    public static func getChatSpecificThemeDarkPreviewTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<(Int32, Int32), NoError> {
        return accountManager.transaction { transaction -> (Int32, Int32) in
    ...
    public static func incrementChatSpecificThemeDarkPreviewTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1, timestamp: Int32) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatSpecificThemeDarkPreviewTip())?.get(ApplicationSpecificTimestampAndCounterNotice.self) {
                currentValue = value.counter
    ...
    public static func getChatForwardOptionsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementChatForwardOptionsTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.chatForwardOptionsTip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
    ...
    public static func getInteractiveEmojiSyncTip(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<(Int32, Int32), NoError> {
        return accountManager.transaction { transaction -> (Int32, Int32) in
    ...
    public static func incrementInteractiveEmojiSyncTip(accountManager: AccountManager<ElloAppAccountManagerTypes>, count: Int = 1, timestamp: Int32) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.interactiveEmojiSyncTip())?.get(ApplicationSpecificTimestampAndCounterNotice.self) {
                currentValue = value.counter
    ...
    public static func dismissedInvitationRequests(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId) -> Signal<[Int64]?, NoError> {
    ...
    public static func setDismissedInvitationRequests(accountManager: AccountManager<ElloAppAccountManagerTypes>, peerId: PeerId, values: [Int64]) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = CodableEntry(ApplicationSpecificInt64ArrayNotice(values: values)) {
    ...
    public static func setForcedPasswordSetup(engine: ElloAppEngine, reloginDaysTimeout: Int32?) -> Signal<Never, NoError> {
    ...
    public static func reset(accountManager: AccountManager<ElloAppAccountManagerTypes>) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
        }
    }
}
