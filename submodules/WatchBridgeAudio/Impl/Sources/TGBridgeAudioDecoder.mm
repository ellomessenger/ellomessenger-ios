...
+ (SQueue *)processingQueue
{
    ...
    {
        static const char *queueSpecific = "org.elloapp.opusAudioDecoderQueue";
        dispatch_queue_t dispatchQueue = dispatch_queue_create("org.elloapp.opusAudioDecoderQueue", DISPATCH_QUEUE_SERIAL);
