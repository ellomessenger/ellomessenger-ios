...
class SecureIdDocumentGalleryItem: GalleryItem {
    ...
    init(context: AccountContext, theme: PresentationTheme, strings: PresentationStrings, secureIdContext: SecureIdAccessContext, itemId: AnyHashable, resource: ElloAppMediaResource, caption: String, location: SecureIdDocumentGalleryEntryLocation, delete: @escaping () -> Void) {
        self.itemId = itemId
...
final class SecureIdDocumentGalleryItemNode: ZoomableContentGalleryItemNode {
    ...
    private var contextAndMedia: (AccountContext, SecureIdAccessContext, ElloAppMediaResource)?
    ...
    fileprivate func setResource(secureIdContext: SecureIdAccessContext, resource: ElloAppMediaResource) {
