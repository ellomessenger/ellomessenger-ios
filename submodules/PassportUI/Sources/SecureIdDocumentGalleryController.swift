...
struct SecureIdDocumentGalleryEntry: Equatable {
    ...
    func item(context: AccountContext, theme: PresentationTheme, strings: PresentationStrings, secureIdContext: SecureIdAccessContext, delete: @escaping (ElloAppMediaResource) -> Void) -> GalleryItem {
...
class SecureIdDocumentGalleryController: ViewController, StandalonePresentableController {
    ...
    var deleteResource: ((ElloAppMediaResource) -> Void)?
    ...
    private func deleteItem(_ resource: ElloAppMediaResource) {
