...
public class SecureIdLocalImageResource: ElloAppMediaResource {
    public let localId: Int64
    public let source: ElloAppMediaResource
    
    public var size: Int64? {
        return nil
    }
    
    public init(localId: Int64, source: ElloAppMediaResource) {
    ...
    public required init(decoder: PostboxDecoder) {
        ...
        self.source = decoder.decodeObjectForKey("s") as! ElloAppMediaResource
    }
