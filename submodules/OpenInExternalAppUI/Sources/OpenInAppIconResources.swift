...
public func fetchOpenInAppIconResource(engine: ElloAppEngine, resource: OpenInAppIconResource) -> Signal<EngineMediaResource.Fetch.Result, EngineMediaResource.Fetch.Error> {
...
private func openInAppIconData(engine: ElloAppEngine, appIcon: OpenInAppIconResource) -> Signal<Data?, NoError> {
...
public func openInAppIcon(engine: ElloAppEngine, appIcon: OpenInAppIcon) -> Signal<(TransformImageArguments) -> DrawingContext?, NoError> {
    switch appIcon {
