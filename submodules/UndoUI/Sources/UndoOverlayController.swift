...
public enum UndoOverlayContent {
    ...
    case dice(dice: ElloAppMediaDice, context: AccountContext, text: String, action: String?)
    ...
    case sticker(context: AccountContext, file: ElloAppMediaFile, title: String?, text: String, undoText: String?, customAction: (() -> Void)?)
...
public final class UndoOverlayController: ViewController {
    ...
    override public func loadDisplayNode() {
        self.displayNode = UndoOverlayControllerNode(presentationData: self.presentationData, 
                                                     content: self.content,
                                                     elevatedLayout: self.elevatedLayout,
                                                     placementPosition: self.position,
