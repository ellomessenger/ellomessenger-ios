            ...
            if let strongSelf = self {
                if case let .complete(info, items) = status {
                    ...
                    Queue.mainQueue().after(1.0) {
                        ...
                        if let firstStickerItem = firstStickerItem, let resource = firstStickerItem.resource as? ElloAppMediaResource {
