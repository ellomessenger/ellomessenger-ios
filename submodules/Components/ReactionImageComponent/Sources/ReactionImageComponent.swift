...
public func reactionStaticImage(context: AccountContext, animation: ElloAppMediaFile, pixelSize: CGSize, queue: Queue) -> Signal<EngineMediaResource.ResourceData, NoError> {
...
public final class ReactionImageNode: ASDisplayNode {
    ...
    public init(context: AccountContext, availableReactions: AvailableReactions?, reaction: MessageReaction.Reaction, displayPixelSize: CGSize) {
        ...
        var animationFile: ElloAppMediaFile?
        ...
        if let animationFile = animationFile {
            ...
            displaySize.width = floor(displaySize.width * 1.25)
            displaySize.height = floor(displaySize.height * 1.25)
    ...
    public func update(size: CGSize) {
        ...
        if self.isAnimation {
            imageSize.width *= 1.25
            imageSize.height *= 1.25
        }
