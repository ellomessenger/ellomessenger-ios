...
public final class ChatRecordedMediaPreview: Equatable {
    ...
    public init(resource: ElloAppMediaResource, duration: Int32, fileSize: Int32, waveform: AudioWaveform) {
...
public final class ChatPresentationInterfaceState: Equatable {
    ...
    public let urlPreview: (String, ElloAppMediaWebpage)?
    public let editingUrlPreview: (String, ElloAppMediaWebpage)?
    ...
    public init(chatWallpaper: ElloAppWallpaper, 
                ...
                peerNearbyData: ChatPeerNearbyData?,
                greetingData: ChatGreetingData?,
                pendingUnpinnedAllMessages: Bool,
                activeGroupCallInfo: ChatActiveGroupCallInfo?,
                hasActiveGroupCall: Bool,
                importState: ChatPresentationImportState?) {
    ...
    public func updatedUrlPreview(_ urlPreview: (String, ElloAppMediaWebpage)?) -> ChatPresentationInterfaceState {
    ...
    public func updatedEditingUrlPreview(_ editingUrlPreview: (String, ElloAppMediaWebpage)?) -> ChatPresentationInterfaceState {
    ...
    public func updatedChatWallpaper(_ chatWallpaper: ElloAppWallpaper) -> ChatPresentationInterfaceState {
