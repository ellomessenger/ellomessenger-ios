...
public final class WebEmbedVideoContent: UniversalVideoContent {
    ...
    public let webpageContent: ElloAppMediaWebpageLoadedContent
    public let dimensions: CGSize
    public let duration: Int32
    let forcedTimestamp: Int?
    let openUrl: (URL) -> Void
    
    public init?(webPage: ElloAppMediaWebpage, webpageContent: ElloAppMediaWebpageLoadedContent, forcedTimestamp: Int? = nil, openUrl: @escaping (URL) -> Void) {
...
final class WebEmbedVideoContentNode: ASDisplayNode, UniversalVideoContentNode {
    private let webpageContent: ElloAppMediaWebpageLoadedContent
    ...
    init(postbox: Postbox, audioSessionManager: ManagedAudioSession, webPage: ElloAppMediaWebpage, webpageContent: ElloAppMediaWebpageLoadedContent, forcedTimestamp: Int? = nil, openUrl: @escaping (URL) -> Void) {
        self.webpageContent = webpageContent
