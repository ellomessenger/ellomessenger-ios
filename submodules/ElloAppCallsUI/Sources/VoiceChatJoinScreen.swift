...
public final class VoiceChatJoinScreen: ViewController {
    ...
    override public func loadDisplayNode() {
        ...
        |> mapToSignal { call -> Signal<(EnginePeer, GroupCallSummary)?, GetCurrentGroupCallError> in
            if let call = call {
                let peer = context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.Peer(id: peerId))
                |> castError(GetCurrentGroupCallError.self)
        ...
        let callJoinAsPeerId = context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.CallJoinAsPeerId(id: peerId))
        |> castError(GetCurrentGroupCallError.self)
