...
enum CallControllerButtonsMode: Equatable {
    struct VideoState: Equatable {
        internal init(isAvailable: Bool = false, isCameraActive: Bool, isScreencastActive: Bool, canChangeStatus: Bool, hasVideo: Bool, isInitializingCamera: Bool) {
            self._isAvailable = isAvailable
            self.isCameraActive = isCameraActive
            self.isScreencastActive = isScreencastActive
            self._canChangeStatus = canChangeStatus
            self._hasVideo = hasVideo
            self.isInitializingCamera = isInitializingCamera
        }
        ...
        private var _canChangeStatus: Bool
        var canChangeStatus: Bool {
            get { false }
            set { }
        }
        private var _hasVideo: Bool
        var hasVideo: Bool {
            get { false }
            set { }
        }
...
//                topButtons.append(.enableCamera(isActive: isCameraActive || isScreencastActive,
//                                                isEnabled: false,
        ...
        for button in buttons {
            ...
            case let .enableCamera(isActivated, isEnabled, isInitializing, isScreencastActive):
                buttonContent = CallControllerButtonItemNode.Content(
                    ...
                    image: isScreencastActive ? .screencast : (isActivated ? .cameraOn : .cameraOff),
                    isEnabled: isEnabled,
