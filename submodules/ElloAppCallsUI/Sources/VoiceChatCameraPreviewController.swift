...
private class VoiceChatCameraPreviewControllerNode: ViewControllerTracingNode, UIScrollViewDelegate {
    ...
    init(controller: VoiceChatCameraPreviewController, sharedContext: SharedAccountContext, cameraNode: PreviewVideoNode) {
        ...
        self.doneButton = SolidRoundedButtonNode(theme: SolidRoundedButtonTheme(backgroundColor: UIColor(rgb: 0xffffff),
                                                                                backgroundColors: [UIColor(hexString: "#7D40FF")!,
                                                                                                   UIColor(hexString: "#FF4066")!,
                                                                                                   UIColor(hexString: "#EEDF53")!,
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        self.placeholderIconNode.image = generateTintedImage(image: UIImage(bundleImageName: "Call/ScreenShareDevices"), color: .white)
