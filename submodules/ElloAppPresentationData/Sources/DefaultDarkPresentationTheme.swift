...
public func customizeDefaultDarkPresentationTheme(theme: PresentationTheme, editing: Bool, title: String?, accentColor: UIColor?, backgroundColors: [UInt32], bubbleColors: [UInt32], animateBubbleColors: Bool?, wallpaper forcedWallpaper: ElloAppWallpaper? = nil, baseColor: PresentationThemeBaseColor? = nil) -> PresentationTheme {
...
//    UIColor(rgb: 0xf38b58)
    UIColor(rgb: 0xFAF6ED),
    UIColor(rgb: 0xFAF6ED),
    UIColor(rgb: 0xC0E0F7),
    UIColor(rgb: 0xC0E0F7)
]
...
public func makeDefaultDarkPresentationTheme(extendingThemeReference: PresentationThemeReference? = nil, preview: Bool) -> PresentationTheme {
    ...
    let list = PresentationThemeList(
        ...
        itemDisclosureActions: PresentationThemeItemDisclosureActions(
            ...
            ʼdefaultʼ: PresentationThemeFillForeground(fillColor: UIColor(hexString: "#CFCFD2")!, foregroundColor: UIColor(hexString: "#FFFFFF")!)
        ),
        ...
        incoming: PresentationThemePartedColors(
            bubble: PresentationThemeBubbleColor(
                withWallpaper: PresentationThemeBubbleColorComponents(
                    ...
                    failedFill: UIColor(rgb: 0x1D1D1D, alpha: incomingBubbleAlpha),
                    stroke: .clear,
                    shadow: nil,
        ...
        outgoing: PresentationThemePartedColors(
            bubble: PresentationThemeBubbleColor(
                withWallpaper: PresentationThemeBubbleColorComponents(
                    ...
                    failedFill: UIColor(rgb: 0x61BCF9),
                    stroke: .clear,
                    shadow: nil,
                    reactionInactiveBackground: UIColor(rgb: 0xffffff, alpha: 0.1),
                    reactionInactiveForeground: UIColor(rgb: 0xffffff),
    ...
    let inputPanel = PresentationThemeChatInputPanel(
        ...
        panelControlCancelButtontColor: UIColor.black,
        panelControlLockButtonStartAnimateColor: UIColor.black,
        panelControlLockButtonEndAnimateColor: UIColor.black,
        panelControlLockButtonBackgroundColor: UIColor.black,
        panelControlLockButtonBorderColor: UIColor.black,
    ...
    let defaultPatternWallpaper: ElloAppWallpaper = defaultBuiltinWallpaper(data: .default, colors: defaultDarkWallpaperGradientColors.map(\.rgb), intensity: -34)
