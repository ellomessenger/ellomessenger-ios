...
public func selectDateFillStaticColor(theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> UIColor {
...
public func selectReactionFillStaticColor(theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> UIColor {
...
public func dateFillNeedsBlur(theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> Bool {
...
public let defaultDayAccentColor = UIColor(rgb: 0x0A49A5)

public func customizeDefaultDayTheme(theme: PresentationTheme, editing: Bool, title: String?, accentColor: UIColor?, outgoingAccentColor: UIColor?, backgroundColors: [UInt32], bubbleColors: [UInt32], animateBubbleColors: Bool?, wallpaper forcedWallpaper: ElloAppWallpaper? = nil, serviceBackgroundColor: UIColor?) -> PresentationTheme {
    ...
    var suggestedWallpaper: ElloAppWallpaper?
    
    var bubbleColors = bubbleColors  
    if bubbleColors.isEmpty, editing {
        if day {
            let accentColor = accentColor ?? defaultDayAccentColor
//            bubbleColors = [UIColor(rgb: 0x0A49A5).rgb]//[accentColor.withMultiplied(hue: 0.966, saturation: 0.61, brightness: 0.98).rgb, accentColor.rgb]
            ...
            if let accentColor = accentColor, !accentColor.alpha.isZero {
                ...
                suggestedWallpaper = .gradient(ElloAppWallpaper.Gradient(id: nil, colors: defaultBuiltinWallpaperGradientColors.map(\.rgb), settings: WallpaperSettings()))
            } else {
                bubbleColors = [UIColor(rgb: 0x0A49A5).rgb]
                suggestedWallpaper = .gradient(ElloAppWallpaper.Gradient(id: nil, colors: defaultBuiltinWallpaperGradientColors.map(\.rgb), settings: WallpaperSettings()))
                outgoingAccent = outgoingAccentColor
            }
        }
    ...
    if !bubbleColors.isEmpty {
        ...
        if lightnessColor.lightness > 0.705 {
            ...
            if let outgoingAccent = outgoingAccent {
                ...
                outgoingScamColor = UIColor(rgb: 0xEF4062)
    ...
    var defaultWallpaper: ElloAppWallpaper?
    if let forcedWallpaper = forcedWallpaper {
        ...
        if backgroundColors.count >= 2 {
            defaultWallpaper = .gradient(ElloAppWallpaper.Gradient(id: nil, colors: backgroundColors, settings: WallpaperSettings()))
        } else {
...
public func makeDefaultDayPresentationTheme(extendingThemeReference: PresentationThemeReference? = nil, serviceBackgroundColor: UIColor?, day: Bool, preview: Bool) -> PresentationTheme {
    ...
    let intro = PresentationThemeIntro(
        ...
        startButtonColor: defaultDayAccentColor, //UIColor(rgb: 0x2ca5e0),
    ...
    let rootNavigationBar = PresentationThemeRootNavigationBar(
        ...
        primaryTextColor: UIColor(rgb: 0x070708),
        secondaryTextColor: UIColor(rgb: 0x929298),
        ...
        badgeBackgroundColor: UIColor(rgb: 0xEF4062),
        badgeStrokeColor: UIColor(rgb: 0xEF4062),
    ...
    let switchColors = PresentationThemeSwitch(
        ...
        contentColor: .white,//UIColor(rgb: 0x35c759),
        positiveColor: UIColor(rgb: 0x00c900),
        negativeColor: UIColor(rgb: 0xEF4062)
    )
    
    let list = PresentationThemeList(
        blocksBackgroundColor: UIColor(rgb: 0xEEEEEF),
        ...
        itemPrimaryTextColor: UIColor(rgb: 0x070708),
        itemSecondaryTextColor: UIColor(rgb: 0x929298),
        itemDisabledTextColor: UIColor(rgb: 0x8e8e93),
        itemAccentColor: defaultDayAccentColor,
        itemHighlightedColor: UIColor(rgb: 0x00b12c),
        itemDestructiveColor: UIColor(rgb: 0xEF4062),
        ...
        freeTextColor: UIColor(rgb: 0x74747B),
        ...
        itemDisclosureActions: PresentationThemeItemDisclosureActions(
            ...
            neutral2: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0xFF9900), foregroundColor: UIColor(rgb: 0xffffff)),
            destructive: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0xEF4062), foregroundColor: UIColor(rgb: 0xffffff)),
            constructive: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0x44BE2E), foregroundColor: UIColor(rgb: 0xffffff)),
            ...
            inactive: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0xbcbcc3), foregroundColor: UIColor(rgb: 0xffffff)), ʼdefaultʼ: PresentationThemeFillForeground(fillColor: UIColor(hexString: "#CFCFD2")!, foregroundColor: UIColor(hexString: "#FFFFFF")!)
        ),
        ...
        freeInputField: PresentationInputFieldTheme(
            ...
            primaryColor: UIColor(rgb: 0x070708),
        ...
        itemInputField: PresentationInputFieldTheme(backgroundColor: UIColor(rgb: 0xf2f2f7), strokeColor: UIColor(rgb: 0xf2f2f7), placeholderColor: UIColor(rgb: 0xb6b6bb), primaryColor: UIColor(rgb: 0x070708), controlColor: UIColor(rgb: 0xb6b6bb)),
        ...
        textGrayLabelColor: UIColor(rgb: 0x929298),
        iconGreenColor: UIColor(rgb: 0x44BE2E)
    )
    
    // MAIN CHAT LIST SETTINGS
    ...
    let chatList = PresentationThemeChatList(
        ...
        titleColor: UIColor(rgb: 0x070708),
        titlePrivateChannelColor: UIColor(rgb: 0x070708),
        titlePrivateGroupColor: UIColor(rgb: 0x070708),
        ...
        checkmarkColor: day ? defaultDayAccentColor : UIColor(rgb: 0x0A49A5), // 0x21c004
        pendingIndicatorColor: UIColor(rgb: 0x8e8e93),
        failedFillColor: UIColor(rgb: 0xEF4062),
        ...
        pinnedBadgeColor: UIColor(rgb: 0x8e8e93),
    ...
    let message = PresentationThemeChatMessage(
        incoming: PresentationThemePartedColors(
            bubble: PresentationThemeBubbleColor(
                withWallpaper: PresentationThemeBubbleColorComponents(
                    ...
                    failedFill: defaultDayAccentColor,
                    stroke: bubbleStrokeColor,
                    shadow: nil,
                    reactionInactiveBackground: UIColor.init(rgb: 0xD8E7FD)/*defaultDayAccentColor.withMultipliedAlpha(0.1)*/,
                    reactionInactiveForeground: UIColor(rgb: 0x070708)/*defaultDayAccentColor*/,
            ...
            scamColor: UIColor(rgb: 0xEF4062),
            ...
            mediaInactiveControlColor: UIColor(rgb: 0x84a4d2),//UIColor(rgb: 0xcacaca),
            mediaControlInnerBackgroundColor: UIColor(rgb: 0xffffff),
            pendingActivityColor: UIColor(rgb: 0x525252, alpha: 0.6),
            fileTitleColor: UIColor(rgb: 0x070708), // Old value UIColor(rgb: 0x0b8bed)
            fileTitleFailedColor: UIColor(rgb: 0xEF4062),
            fileDescriptionColor: UIColor(rgb: 0x999999),
            fileNeedLoadColor: PresentationThemeFillForeground(fillColor: defaultDayAccentColor, foregroundColor: UIColor(rgb: 0xffffff)),
        ...
        outgoing: PresentationThemePartedColors(
            bubble: PresentationThemeBubbleColor(
                withWallpaper: PresentationThemeBubbleColorComponents(
                    fill: [UIColor(rgb: 0x0a49a5)],
                    highlightedFill: UIColor(rgb: 0x0a49a5),
                    failedFill: UIColor(rgb: 0xFBCFD8),
                    stroke: bubbleStrokeColor,
                    shadow: nil,
                    reactionInactiveBackground: UIColor(rgb: 0xFFFFFF).withMultipliedAlpha(0.2),
                    reactionInactiveForeground: UIColor(rgb: 0xFFFFFF),
                    reactionActiveBackground: UIColor(rgb: 0xD8E7FD),
                    reactionActiveForeground: UIColor(rgb: 0x070708),
                    reactionInactiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2),
                    reactionActiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2)
                ),
                withoutWallpaper: PresentationThemeBubbleColorComponents(
            ...
            linkTextColor: UIColor(rgb: 0xc3dbfa),//0x004bad
            linkHighlightColor: defaultDayAccentColor.withAlphaComponent(0.3),
            scamColor: UIColor(rgb: 0xEF4062),
            textHighlightColor: UIColor(rgb: 0xffe438),
            ...
            mediaActiveControlColor: UIColor(rgb: 0xffffff),//UIColor(rgb: 0x3fc33b),
            mediaInactiveControlColor: UIColor(rgb: 0x84a4d2),
            mediaControlInnerBackgroundColor: UIColor(rgb: 0xffffff),//UIColor(rgb: 0xe1ffc7),
            pendingActivityColor: UIColor(rgb: 0xffffff),
            fileTitleColor: UIColor(rgb: 0xffffff),
            fileTitleFailedColor: UIColor(rgb: 0xEF4062),
            fileDescriptionColor: UIColor(rgb: 0xffffff),//UIColor(rgb: 0x6fb26a),
            fileNeedLoadColor: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0xffffff), foregroundColor: .clear),
            fileDurationColor: UIColor(rgb: 0xffffff),//UIColor(rgb: 0x008c09, alpha: 0.8),
        ...
        freeform: PresentationThemeBubbleColor(
            withWallpaper: PresentationThemeBubbleColorComponents(
                fill: [UIColor(rgb: 0xffffff)],
                highlightedFill: UIColor(rgb: 0xd9f4ff),
                failedFill: UIColor(rgb: 0xffffff),
                stroke: UIColor(rgb: 0x86a9c9, alpha: 0.5),
                shadow: nil,
                reactionInactiveBackground: UIColor(rgb: 0xF0F6FF),
                reactionInactiveForeground: UIColor(rgb: 0x070708),
                reactionActiveBackground: defaultDayAccentColor, //UIColor(rgb: 0xffffff, alpha: 0.8),
                reactionActiveForeground: UIColor.white,
                reactionInactiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2),
                reactionActiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2)
            ),
            withoutWallpaper: PresentationThemeBubbleColorComponents(
        ...
        infoLinkTextColor: UIColor(rgb: 0xc3dbfa),//0x004bad
        outgoingCheckColor: UIColor(rgb: 0xffffff),//0x19c700
        ...
        deliveryFailedColors: PresentationThemeFillForeground(fillColor: UIColor(rgb: 0xEF4062), foregroundColor: UIColor(rgb: 0xffffff)),
    ...
    let messageDay = PresentationThemeChatMessage(
        incoming: PresentationThemePartedColors(
            ...
            fileTitleFailedColor: UIColor(rgb: 0xEF4062),
            fileDescriptionColor: UIColor(rgb: 0x999999),
            fileNeedLoadColor: PresentationThemeFillForeground(fillColor: .red, foregroundColor: .orange),
            fileDurationColor: UIColor(rgb: 0x525252, alpha: 0.6),
    ...
    let serviceMessageDay = PresentationThemeServiceMessage(
        components: PresentationThemeServiceMessageColor(withDefaultWallpaper: PresentationThemeServiceMessageColorComponents(fill: UIColor(rgb: 0xffffff, alpha: 0.8), primaryText: UIColor(rgb: 0x8d8e93), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xEF4062), dateFillStatic: UIColor(rgb: 0xffffff, alpha: 0.8), dateFillFloating: UIColor(rgb: 0xffffff, alpha: 0.8)), withCustomWallpaper: PresentationThemeServiceMessageColorComponents(fill: serviceBackgroundColor, primaryText: UIColor(rgb: 0xffffff), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xEF4062), dateFillStatic: UIColor(rgb: 0x000000, alpha: 0.2), dateFillFloating: serviceBackgroundColor.withAlphaComponent(serviceBackgroundColor.alpha * 0.6667))),
    ...
    let inputPanelMediaRecordingControl = PresentationThemeChatInputPanelMediaRecordingControl(
        ...
        activeIconColor: UIColor(rgb: 0x929298)
    )
    
    // CHAT BOTTOM PANEL WITH AUDIO RECORD CONTROLL
    let inputPanel = PresentationThemeChatInputPanel(
        ...
        panelControlDestructiveColor: UIColor(rgb: 0xEF4062),
        panelControlCancelButtontColor: defaultDayAccentColor,
        panelControlLockButtonStartAnimateColor: .white,
        panelControlLockButtonEndAnimateColor: .white,
        panelControlLockButtonBackgroundColor: .black,
        panelControlLockButtonBorderColor: .black,
        ...
        actionControlBackgroundColor: UIColor(hexString: "219653") ?? .black,
        actionControlForegroundColor: UIColor(rgb: 0xffffff),
        primaryTextColor: UIColor(rgb: 0x000000),
        secondaryTextColor: UIColor(rgb: 0x929298),
        timerTextColor: UIColor(hexString: "#EF4062") ?? .black,
    ...
    let inputMediaPanel = PresentationThemeInputMediaPanel(
        ...
        stickersSearchPrimaryColor: UIColor(rgb: 0x070708),
    ...
    let defaultPatternWallpaper: ElloAppWallpaper = defaultBuiltinWallpaperUseGradien(data: .default, colors: defaultBuiltinWallpaperGradientWithTwoColors.map(\.rgb), rotation: nil)
    ...
    let actionSheet = PresentationThemeActionSheet(
        ...
        itemBackgroundColor: UIColor(rgb: 0xF6F6F6), //UIColor(white: 1.0, alpha: 0.92), //UIColor(rgb: 0xDEDEE1),//UIColor(white: 1.0, alpha: 0.8),
        ...
        standardActionTextColor: defaultDayAccentColor, // 0x0A49A5
        destructiveActionTextColor: UIColor(rgb: 0xEF4062),
        disabledActionTextColor: UIColor(rgb: 0xb3b3b3),
        primaryTextColor: UIColor(rgb: 0x000000),
        secondaryTextColor: UIColor(rgb: 0x929298),
        controlAccentColor: defaultDayAccentColor, // 0x0A49A5
    ...
    let contextMenu = PresentationThemeContextMenu(
        ...
        sectionSeparatorColor: UIColor(rgb: 0xD9D9D9, alpha: 0.2),
        ...
        destructiveColor: UIColor(rgb: 0xEF4062),
        badgeFillColor: defaultDayAccentColor, // 0x0A49A5
...
public let defaultBuiltinWallpaperGradientColors: [UIColor] = [
    UIColor(rgb: 0xc4def4),
    UIColor(rgb: 0xc4def4),
    UIColor(rgb: 0xfbf5ec),
    UIColor(rgb: 0xfbf5ec)
]

public let defaultBuiltinWallpaperGradientWithTwoColors: [UIColor] = [
    UIColor(rgb: 0xFEF4E9),
    UIColor(rgb: 0xB8E0F9)
]
...
public func defaultBuiltinWallpaper(data: BuiltinWallpaperData, colors: [UInt32], intensity: Int32 = 50, rotation: Int32? = nil) -> ElloAppWallpaper {
    return .file(ElloAppWallpaper.File(
        id: data.wallpaperId,
        ...
        file: ElloAppMediaFile(
            ...
            resource: CloudDocumentMediaResource(
                ...
                fileReference: Data(),
                fileName: "patterns.tgv"
            ),
            previewRepresentations: [
                ElloAppMediaImageRepresentation(
            ...
            attributes: [
                ...
                .FileName(fileName: "patterns.tgv")
            ]
        ),
...
public func defaultBuiltinWallpaperUseGradien(data: BuiltinWallpaperData, colors: [UInt32], intensity: Int32 = 50, rotation: Int32? = nil) -> ElloAppWallpaper {

    return .gradient(.init(id: nil, colors: colors, settings: WallpaperSettings(colors: colors, intensity: intensity, rotation: rotation)))
}
