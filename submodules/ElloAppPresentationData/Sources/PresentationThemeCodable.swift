...
struct ElloAppWallpaperStandardizedCodable: Codable {
    let value: ElloAppWallpaper

    init(_ value: ElloAppWallpaper) {
        self.value = value
    }
            ...
            switch value.lowercased() {
                ...
                default:
                    ...
                    if [6, 8].contains(value.count), let color = UIColor(hexString: value) {
                        ...
                        if let slug = slug {
                            self.value = .file(ElloAppWallpaper.File(id: 0, accessHash: 0, isCreator: false, isDefault: false, isPattern: !colors.isEmpty, isDark: false, slug: slug, file: ElloAppMediaFile(fileId: MediaId(namespace: 0, id: 0), partialReference: nil, resource: WallpaperDataResource(slug: slug), previewRepresentations: [], videoThumbnails: [], immediateThumbnailData: nil, mimeType: "", size: nil, attributes: []), settings: WallpaperSettings(blur: blur, motion: motion, colors: colors.map { $0.argb }, intensity: intensity, rotation: rotation)))
                        } else if colors.count > 1 {
                            self.value = .gradient(ElloAppWallpaper.Gradient(id: nil, colors: colors.map { $0.argb }, settings: WallpaperSettings(blur: blur, motion: motion, rotation: rotation)))
                        } else {
                            throw PresentationThemeDecodingError.generic
                        }
                    }
...
extension PresentationThemeItemDisclosureActions: Codable {
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(neutral1: try values.decode(PresentationThemeFillForeground.self, forKey: .neutral1),
                  ...
                  ʼdefaultʼ: try values.decode(PresentationThemeFillForeground.self, forKey: .ʼdefaultʼ))
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encode(self.ʼdefaultʼ, forKey: .ʼdefaultʼ)
    }
}
...
extension PresentationThemeChatList: Codable {
    enum CodingKeys: String, CodingKey {
        ...
        case itemSelectedBg
        case title
        case titlePrivateChannel
        case titlePrivateGroup
        case secretTitle
        case dateText
        case authorName
        case messageText
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(backgroundColor: try decodeColor(values, .bg),
                  ...
                  titlePrivateChannelColor: try decodeColor(values, .titlePrivateChannel),
                  titlePrivateGroupColor: try decodeColor(values, .titlePrivateGroup),
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try encodeColor(&values, self.titlePrivateChannelColor, .titlePrivateChannel)
        try encodeColor(&values, self.titlePrivateGroupColor, .titlePrivateGroup)
...
extension PresentationThemeBubbleColorComponents: Codable {
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            failedFill: try decodeColor(values, .failedFill),
...
extension PresentationThemePartedColors: Codable {
    enum CodingKeys: String, CodingKey {
        ...
        case fileTitle
        case fileTitleFailed
        case fileDescription
        case fileNeedLoadColor
        case fileDuration
        case mediaPlaceholder
        case polls
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            fileTitleFailedColor: try decodeColor(values, .fileTitleFailed),
            fileDescriptionColor: try decodeColor(values, .fileDescription),
            fileNeedLoadColor: try values.decode(PresentationThemeFillForeground.self, forKey: .fileNeedLoadColor),
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try encodeColor(&values, self.fileTitleFailedColor, .fileTitleFailed)
        try encodeColor(&values, self.fileDescriptionColor, .fileDescription)
        try values.encode(self.fileNeedLoadColor, forKey: .fileNeedLoadColor)
...
extension PresentationThemeChatInputPanel: Codable {
    enum CodingKeys: String, CodingKey {
        ...
        case panelControlCancelButtontColor
        case panelControlLockButtonStartAnimateColor
        case panelControlLockButtonEndAnimateColor
        case panelControlLockButtonBackgroundColor
        case panelControlLockButtonBorderColor
        case inputBg
        case inputStroke
        case inputPlaceholder
        case inputText
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(panelBackgroundColor: try decodeColor(values, .panelBg),
                  ...
                  panelControlCancelButtontColor: try decodeColor(values, .panelControlCancelButtontColor),
                  panelControlLockButtonStartAnimateColor: try decodeColor(values, .panelControlLockButtonStartAnimateColor),
                  panelControlLockButtonEndAnimateColor: try decodeColor(values, .panelControlLockButtonEndAnimateColor),
                  panelControlLockButtonBackgroundColor: try decodeColor(values, .panelControlLockButtonBackgroundColor),
                  panelControlLockButtonBorderColor: try decodeColor(values, .panelControlLockButtonBorderColor),
                  inputBackgroundColor: try decodeColor(values, .inputBg),
                  ...
                  actionControlBackgroundColor: try decodeColor(values, .actionControlPnBg),
                  actionControlForegroundColor: try decodeColor(values, .actionControlFg),
                  primaryTextColor: try decodeColor(values, .primaryText),
                  secondaryTextColor: try decodeColor(values, .secondaryText),
                  timerTextColor: try decodeColor(values, .secondaryText),
...
extension PresentationThemeChat: Codable {
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        var wallpaper = (try values.decode(ElloAppWallpaperStandardizedCodable.self, forKey: .defaultWallpaper)).value
    ...
    public func encode(to encoder: Encoder) throws {
        var values = encoder.container(keyedBy: CodingKeys.self)
        try values.encode(ElloAppWallpaperStandardizedCodable(self.defaultWallpaper), forKey: .defaultWallpaper)
