...
public final class PresentationThemeItemDisclosureActions {
    ...
    public let ʼdefaultʼ: PresentationThemeFillForeground
    
    public init(neutral1: PresentationThemeFillForeground, neutral2: PresentationThemeFillForeground, destructive: PresentationThemeFillForeground, constructive: PresentationThemeFillForeground, accent: PresentationThemeFillForeground, warning: PresentationThemeFillForeground, inactive: PresentationThemeFillForeground, ʼdefaultʼ: PresentationThemeFillForeground) {
...
public final class PresentationThemeList {
    ...
    public let textGrayLabelColor: UIColor
    public let iconGreenColor: UIColor
    ...
    public init(
        ...
        textGrayLabelColor: UIColor,
        iconGreenColor: UIColor
    ) {
...
public final class PresentationThemeChatList {
    ...
    public let titlePrivateChannelColor: UIColor
    public let titlePrivateGroupColor: UIColor
    ...
    init(
        ...
        titleColor: UIColor,
        titlePrivateChannelColor: UIColor,
        titlePrivateGroupColor: UIColor,
        ...
        self.titlePrivateChannelColor = titlePrivateChannelColor
        self.titlePrivateGroupColor = titlePrivateGroupColor
    ...
    public func withUpdated(
        ...
        titlePrivateChannelColor: UIColor? = nil,
        titlePrivateGroupColor: UIColor? = nil,
        ...
        return PresentationThemeChatList(
            ...
            titlePrivateChannelColor: titlePrivateChannelColor ?? self.titlePrivateChannelColor,
            titlePrivateGroupColor: titlePrivateGroupColor ?? self.titlePrivateGroupColor,
...
public final class PresentationThemeBubbleColorComponents {
    ...
    public func withUpdated(
        ...
        return PresentationThemeBubbleColorComponents(
            ...
            failedFill: failedFill ?? self.failedFill,
...
// CHAT MESSAGE DAY TEXT
public func bubbleVariableColor(variableColor: PresentationThemeVariableColor, wallpaper: ElloAppWallpaper) -> UIColor {
    switch wallpaper {
        case .color(0xffffff):
...
public final class PresentationThemePartedColors {
    ...
    public let fileTitleFailedColor: UIColor
    public let fileDescriptionColor: UIColor
    public let fileNeedLoadColor: PresentationThemeFillForeground
    ...
    public init(bubble: PresentationThemeBubbleColor, primaryTextColor: UIColor, secondaryTextColor: UIColor, linkTextColor: UIColor, linkHighlightColor: UIColor, scamColor: UIColor, textHighlightColor: UIColor, accentTextColor: UIColor, accentControlColor: UIColor, accentControlDisabledColor: UIColor, mediaActiveControlColor: UIColor, mediaInactiveControlColor: UIColor, mediaControlInnerBackgroundColor: UIColor, pendingActivityColor: UIColor, fileTitleColor: UIColor, fileTitleFailedColor: UIColor, fileDescriptionColor: UIColor, fileNeedLoadColor: PresentationThemeFillForeground, fileDurationColor: UIColor, mediaPlaceholderColor: UIColor, polls: PresentationThemeChatBubblePolls, actionButtonsFillColor: PresentationThemeVariableColor, actionButtonsStrokeColor: PresentationThemeVariableColor, actionButtonsTextColor: PresentationThemeVariableColor, textSelectionColor: UIColor, textSelectionKnobColor: UIColor) {
        ...
        self.fileTitleFailedColor = fileTitleFailedColor
        self.fileDescriptionColor = fileDescriptionColor
        self.fileNeedLoadColor = fileNeedLoadColor
...
public func serviceMessageColorComponents(theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> PresentationThemeServiceMessageColorComponents {
    return serviceMessageColorComponents(chatTheme: theme.chat, wallpaper: wallpaper)
}

public func serviceMessageColorHasDefaultWallpaper(_ wallpaper: ElloAppWallpaper) -> Bool {
    switch wallpaper {
        case .color(0xffffff):
            return true
        default:
...
public func serviceMessageColorComponents(chatTheme: PresentationThemeChat, wallpaper: ElloAppWallpaper) -> PresentationThemeServiceMessageColorComponents {
...
public final class PresentationThemeChatInputPanel {
    ...
    public let panelControlBackgroundColor: UIColor
    public let panelControlTextColor: UIColor
    ...
    public let panelControlCancelButtontColor: UIColor
    public let panelControlLockButtonStartAnimateColor: UIColor
    public let panelControlLockButtonEndAnimateColor: UIColor
    public let panelControlLockButtonBackgroundColor: UIColor
    public let panelControlLockButtonBorderColor: UIColor
    public let inputBackgroundColor: UIColor
    ...
    public let actionControlBackgroundColor: UIColor
    public let actionControlForegroundColor: UIColor
    public let primaryTextColor: UIColor
    public let secondaryTextColor: UIColor
    public let timerTextColor: UIColor
    ...
    public init(panelBackgroundColor: UIColor, panelBackgroundColorNoWallpaper: UIColor, panelSeparatorColor: UIColor, panelControlAccentColor: UIColor, panelControlBackgroundColor: UIColor = .clear, panelControlTextColor: UIColor? = nil , panelControlColor: UIColor, panelControlDisabledColor: UIColor, panelControlDestructiveColor: UIColor, panelControlCancelButtontColor: UIColor, panelControlLockButtonStartAnimateColor: UIColor, panelControlLockButtonEndAnimateColor: UIColor, panelControlLockButtonBackgroundColor: UIColor, panelControlLockButtonBorderColor: UIColor, inputBackgroundColor: UIColor, inputStrokeColor: UIColor, inputPlaceholderColor: UIColor, inputTextColor: UIColor, inputControlColor: UIColor, actionControlFillColor: UIColor, actionControlBackgroundColor: UIColor, actionControlForegroundColor: UIColor, primaryTextColor: UIColor, secondaryTextColor: UIColor, timerTextColor: UIColor, mediaRecordingDotColor: UIColor, mediaRecordingControl: PresentationThemeChatInputPanelMediaRecordingControl) {
        ...
        self.panelControlTextColor = panelControlTextColor ?? panelControlAccentColor
        self.panelControlBackgroundColor = panelControlBackgroundColor
        ...
        self.panelControlCancelButtontColor = panelControlCancelButtontColor
        self.panelControlLockButtonStartAnimateColor = panelControlLockButtonStartAnimateColor
        self.panelControlLockButtonEndAnimateColor = panelControlLockButtonEndAnimateColor
        self.panelControlLockButtonBackgroundColor = panelControlLockButtonBackgroundColor
        self.panelControlLockButtonBorderColor = panelControlLockButtonBorderColor
        self.inputBackgroundColor = inputBackgroundColor
        ...
        self.actionControlBackgroundColor = actionControlBackgroundColor
    ...
    public func withUpdated(panelBackgroundColor: UIColor? = nil, panelBackgroundColorNoWallpaper: UIColor? = nil, panelSeparatorColor: UIColor? = nil, panelControlAccentColor: UIColor? = nil, panelControlBackgroundColor: UIColor? = nil, panelControlTextColor: UIColor? = nil, panelControlColor: UIColor? = nil, panelControlDisabledColor: UIColor? = nil, panelControlDestructiveColor: UIColor? = nil, panelControlCancelButtontColor: UIColor? = nil, panelControlLockButtonStartAnimateColor: UIColor? = nil, panelControlLockButtonEndAnimateColor: UIColor? = nil, panelControlLockButtonBackgroundColor: UIColor? = nil, panelControlLockButtonBorderColor: UIColor? = nil, inputBackgroundColor: UIColor? = nil, inputStrokeColor: UIColor? = nil, inputPlaceholderColor: UIColor? = nil, inputTextColor: UIColor? = nil, inputControlColor: UIColor? = nil, actionControlFillColor: UIColor? = nil, actionControlForegroundColor: UIColor? = nil, primaryTextColor: UIColor? = nil, secondaryTextColor: UIColor? = nil, timerTextColor: UIColor? = nil, mediaRecordingDotColor: UIColor? = nil, mediaRecordingControl: PresentationThemeChatInputPanelMediaRecordingControl? = nil) -> PresentationThemeChatInputPanel {
        return PresentationThemeChatInputPanel(panelBackgroundColor: panelBackgroundColor ?? self.panelBackgroundColor, panelBackgroundColorNoWallpaper: panelBackgroundColorNoWallpaper ?? self.panelBackgroundColorNoWallpaper, panelSeparatorColor: panelSeparatorColor ?? self.panelSeparatorColor, panelControlAccentColor: panelControlAccentColor ?? self.panelControlAccentColor, panelControlBackgroundColor: panelControlBackgroundColor ?? self.panelControlBackgroundColor, panelControlTextColor: panelControlTextColor ?? self.panelControlTextColor, panelControlColor: panelControlColor ?? self.panelControlColor, panelControlDisabledColor: panelControlDisabledColor ?? self.panelControlDisabledColor, panelControlDestructiveColor: panelControlDestructiveColor ?? self.panelControlDestructiveColor, panelControlCancelButtontColor: panelControlCancelButtontColor ?? self.panelControlCancelButtontColor, panelControlLockButtonStartAnimateColor: panelControlLockButtonStartAnimateColor ?? self.panelControlLockButtonStartAnimateColor, panelControlLockButtonEndAnimateColor: panelControlLockButtonEndAnimateColor ?? self.panelControlLockButtonEndAnimateColor, panelControlLockButtonBackgroundColor: panelControlLockButtonBackgroundColor ?? self.panelControlLockButtonBackgroundColor, panelControlLockButtonBorderColor: panelControlLockButtonBorderColor ?? self.panelControlLockButtonBorderColor, inputBackgroundColor: inputBackgroundColor ?? self.inputBackgroundColor, inputStrokeColor: inputStrokeColor ?? self.inputStrokeColor, inputPlaceholderColor: inputPlaceholderColor ?? self.inputPlaceholderColor, inputTextColor: inputTextColor ?? self.inputTextColor, inputControlColor: inputControlColor ?? self.inputControlColor, actionControlFillColor: actionControlFillColor ?? self.actionControlFillColor, actionControlBackgroundColor: actionControlBackgroundColor, actionControlForegroundColor: actionControlForegroundColor ?? self.actionControlForegroundColor, primaryTextColor: primaryTextColor ?? self.primaryTextColor, secondaryTextColor: secondaryTextColor ?? self.secondaryTextColor, timerTextColor: timerTextColor ?? self.timerTextColor, mediaRecordingDotColor: mediaRecordingDotColor ?? self.mediaRecordingDotColor, mediaRecordingControl: mediaRecordingControl ?? self.mediaRecordingControl)
    }
}
...
public final class PresentationThemeChat {
    public let defaultWallpaper: ElloAppWallpaper
...
public final class PresentationTheme: Equatable {
    ...
    public func withUpdated(name: String?, defaultWallpaper: ElloAppWallpaper?) -> PresentationTheme {
    ...
    public func withUpdated(chat: PresentationThemeChat) -> PresentationTheme {
        return PresentationTheme(name: self.name, index: self.index, referenceTheme: self.referenceTheme, overallDarkAppearance: self.overallDarkAppearance, intro: self.intro, passcode: self.passcode, rootController: self.rootController, list: self.list, chatList: self.chatList, chat: chat, actionSheet: self.actionSheet, contextMenu: self.contextMenu, inAppNotification: self.inAppNotification, chart: self.chart, preview: self.preview)
    }
    ...
    public static let isTabbarTitleShown = false
}
