...
private var backgroundImageForWallpaper: (ElloAppWallpaper, Bool, UIImage)?

public func chatControllerBackgroundImage(theme: PresentationTheme?, 
                                          wallpaper initialWallpaper: ElloAppWallpaper,
                                          mediaBox: MediaBox,
                                          composed: Bool = true,
                                          knockoutMode: Bool,
                                          cached: Bool = true) -> UIImage? {
...
private var signalBackgroundImageForWallpaper: (ElloAppWallpaper, Bool, UIImage)?

public func chatControllerBackgroundImageSignal(wallpaper: ElloAppWallpaper, mediaBox: MediaBox, accountMediaBox: MediaBox) -> Signal<(UIImage?, Bool)?, NoError> {
