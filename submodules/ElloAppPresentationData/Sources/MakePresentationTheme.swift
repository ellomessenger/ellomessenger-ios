...
public func makePresentationTheme(settings: ElloAppThemeSettings, title: String? = nil, serviceBackgroundColor: UIColor? = nil) -> PresentationTheme? {
...
public func makePresentationTheme(cloudTheme: ElloAppTheme, dark: Bool = false) -> PresentationTheme? {
    let settings: ElloAppThemeSettings?
...
public func makePresentationTheme(cloudTheme: ElloAppTheme, baseTheme: ElloAppBaseTheme? = nil) -> PresentationTheme? {
    let settings: ElloAppThemeSettings?
...
public func makePresentationTheme(mediaBox: MediaBox, themeReference: PresentationThemeReference, baseTheme: ElloAppBaseTheme? = nil, extendingThemeReference: PresentationThemeReference? = nil, accentColor: UIColor? = nil, outgoingAccentColor: UIColor? = nil, backgroundColors: [UInt32] = [], bubbleColors: [UInt32] = [], animateBubbleColors: Bool? = nil, wallpaper: ElloAppWallpaper? = nil, baseColor: PresentationThemeBaseColor? = nil, serviceBackgroundColor: UIColor? = nil, preview: Bool = false) -> PresentationTheme? {
