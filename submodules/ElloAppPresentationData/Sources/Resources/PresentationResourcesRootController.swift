...
//        return theme.image(PresentationResourceKey.navigationShareIcon.rawValue, generateShareButtonImage)
    ...
    public static func navigationEditIcon(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.navigationQrCodeIcon.rawValue, { theme in
            generateTintedImage(image: UIImage(bundleImageName: "Settings/settings_edit_icon"), color: theme.rootController.navigationBar.accentTextColor)
        })
    }
    ...
    public static func navigationAddIcon(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.navigationAddIcon.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat List/AddIcon3"), color: theme.rootController.navigationBar.accentTextColor)
        })
    }
    
    public static func navigationQuickLinksIcon(_ theme: PresentationTheme) -> UIImage? {
        theme.image(PresentationResourceKey.navigationQuickLinksIcon.rawValue, { theme in
            UIImage(bundleImageName: "Chat List/QuickLinksIcon3")
        })
    }

    public static func navigationAIBotIcon(_ theme: PresentationTheme) -> UIImage? {
        theme.image(PresentationResourceKey.navigationAIBotIcon.rawValue, { theme in
            UIImage(bundleImageName: "Chat List/AIBotIcon3")
        })
    }

    public static func navigationAIPhoenixBotIcon(_ theme: PresentationTheme) -> UIImage? {
        theme.image(PresentationResourceKey.navigationAIPhoenixBotIcon.rawValue, { theme in
            UIImage(bundleImageName: "Chat List/AIPhoenixBotIcon")
        })
    }

    public static func navigationAIBusinessForStudentsBotIcon(_ theme: PresentationTheme) -> UIImage? {
        theme.image(PresentationResourceKey.navigationAIBusinessForStudentsBotIcon.rawValue, { theme in
            UIImage(bundleImageName: "Chat List/AIBusinessForStudentsBotIcon")
        })
    }

    public static func navigationAICancerPreventionBotIcon(_ theme: PresentationTheme) -> UIImage? {
        theme.image(PresentationResourceKey.navigationAICancerPreventionBotIcon.rawValue, { theme in
            UIImage(bundleImageName: "Chat List/AICancerPrevention")
        })
    }
