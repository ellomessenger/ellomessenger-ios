...
public enum PresentationResourceKey: Int32 {
    ...
    case navigationQuickLinksIcon
    case navigationAIBotIcon
    case navigationAIPhoenixBotIcon
    case navigationAIBusinessForStudentsBotIcon
    case navigationAICancerPreventionBotIcon
    ...
    case chatInputPanelPinnedIconImage
