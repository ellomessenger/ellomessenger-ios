...
public struct PresentationResourcesChat {
    ...
    public static func principalGraphics(theme: PresentationTheme, wallpaper: ElloAppWallpaper, bubbleCorners: PresentationChatBubbleCorners) -> PrincipalThemeEssentialGraphics {
    ...
    public static func additionalGraphics(_ theme: PresentationTheme, wallpaper: ElloAppWallpaper, bubbleCorners: PresentationChatBubbleCorners) -> PrincipalThemeAdditionalGraphics {
    ...
    public static func chatInstantVideoBackgroundImage(_ theme: PresentationTheme, wallpaper: Bool) -> UIImage? {
        ...
        return theme.image(key.rawValue, { theme in
            return generateInstantVideoBackground(fillColor: theme.chat.message.freeform.withWallpaper.fill[0], strokeColor: UIColor.white)
        })
    }
...
//    }
    ...
    public static func chatInputPanelPinnedIconImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatInputPanelPinnedIconImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Input/Accessory Panels/PinnedIcon"), color: theme.chat.inputPanel.panelControlAccentColor)
        })
    }
    
    public static func chatInputPanelCloseIconImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatInputPanelCloseIconImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Input/Accessory Panels/PinnedCircleCloseButton"), color: theme.chat.inputPanel.panelControlAccentColor)
        })
    }
    ...
    public static func chatInputPanelSettingsActiveButtonImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatInputPanelVideoActiveButtonImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/AISettings"), color: theme.chat.inputPanel.mediaRecordingControl.activeIconColor)
        })
    }
    ...
    public static func chatBubbleIncomingCallButtonImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatBubbleIncomingCallButtonImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Info/CallButton"),
                                             color: UIColor(hexString: "B1B1B5")!)
        })
    }
    ...
    public static func chatBubbleOutgoingCallButtonImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatBubbleOutgoingCallButtonImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Info/CallButton"),
                                             color: UIColor(hexString: "0A49A5")!)
        })
    }
    ...
    public static func chatBubbleIncomingVideoCallButtonImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatBubbleIncomingVideoCallButtonImage.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat/Info/VideoCallButton"),
                                             color: UIColor(hexString: "0A49A5")!)
        })
    }
    ...
    public static func chatBubbleIncomingBackgroundImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatBubbleOutgoingVideoCallButtonImage.rawValue, { theme in
            return generateFilledCircleImage(diameter: 40.0, color: UIColor(hexString: "070708")?.withAlphaComponent(0.15))
        })
    }
    
    public static func chatBubbleOutgoingBackgroundImage(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatBubbleOutgoingVideoCallButtonImage.rawValue, { theme in
            return generateFilledCircleImage(diameter: 40.0, color: UIColor(hexString: "EEEEEF")!)
        })
    }
    ...
    public static func chatMessageAttachedContentButtonIncoming(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatMessageAttachedContentButtonIncoming.rawValue, { theme in
            return generateStretchableFilledCircleImage(diameter: 20.0, color: nil, strokeColor: theme.chat.message.incoming.accentControlColor, strokeWidth: 1.0, backgroundColor: nil)
        })
    }
    ...
    public static func chatMessageAttachedContentHighlightedButtonIncoming(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatMessageAttachedContentHighlightedButtonIncoming.rawValue, { theme in
            return generateStretchableFilledCircleImage(diameter: 20.0, color: theme.chat.message.incoming.accentControlColor)
        })
    }
    ...
    public static func chatMessageAttachedContentButtonOutgoing(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatMessageAttachedContentButtonOutgoing.rawValue, { theme in
            return generateStretchableFilledCircleImage(diameter: 20.0, color: nil, strokeColor: theme.chat.message.outgoing.primaryTextColor, strokeWidth: 1.0, backgroundColor: nil)
        })
    }
    ...
    public static func chatMessageAttachedContentHighlightedButtonOutgoing(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.chatMessageAttachedContentHighlightedButtonOutgoing.rawValue, { theme in
            return generateStretchableFilledCircleImage(diameter: 20.0, color: theme.chat.message.outgoing.primaryTextColor)
        })
    }
    ...
    public static func chatMessageFreeLike(_ theme: PresentationTheme, wallpaper: ElloAppWallpaper, isSelected: Bool) -> UIImage? {
    ...
    public static func chatFreeCommentButtonIcon(_ theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> UIImage? {
    ...
    public static func chatFreeNavigateButtonIcon(_ theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> UIImage? {
    ...
    public static func chatFreeShareButtonIcon(_ theme: PresentationTheme, wallpaper: ElloAppWallpaper) -> UIImage? {
