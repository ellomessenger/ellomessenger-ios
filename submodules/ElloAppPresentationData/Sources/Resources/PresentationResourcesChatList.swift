...
public struct PresentationResourcesChatList {
    ...
    public static func peerTypeIcon(payType: ElloAppChannelPayType) -> UIImage? {
        switch payType {
        case .free:
            return nil
        case .onlineCourse:
            return UIImage(bundleImageName: "Chat List/PaidChannel/OnlineCourseIcon")
        case .subscription:
            return UIImage(bundleImageName: "Chat List/PaidChannel/SubscriptionIcon")
        }
    }
    
    public static func adultIcon() -> UIImage? {
        UIImage(bundleImageName: "Chat List/PaidChannel/18+Icon")
    }
    
    public static func privateChannelIcon() -> UIImage? {
        UIImage(bundleImageName: "Chat List/PrivateChannel/PrivateIcon")
    }
