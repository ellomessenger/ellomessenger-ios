...
public struct PresentationResourcesSettings {
    ...
    public static let wallet = renderIcon(name: "Settings/ElloSettings/wallet")
    public static let subscriptions = renderIcon(name: "Settings/ElloSettings/subscriptions")
    public static let earnings = renderIcon(name: "Settings/ElloSettings/earnings")
    public static let purchases = renderIcon(name: "Settings/ElloSettings/purchases")
    public static let invite = renderIcon(name: "Settings/ElloSettings/invite")
    public static let folders = renderIcon(name: "Settings/ElloSettings/folders")
    public static let loyalty = renderIcon(name: "Settings/ElloSettings/loyalty")
    public static let settings = renderIcon(name: "Settings/ElloSettings/settings")
    public static let cloud = renderIcon(name: "Settings/ElloSettings/cloud")
    public static let elloAI = renderIcon(name: "Settings/ElloSettings/elloAI")
    public static let profileNotifications = renderIcon(name: "Settings/ElloSettings/notifications")
}
