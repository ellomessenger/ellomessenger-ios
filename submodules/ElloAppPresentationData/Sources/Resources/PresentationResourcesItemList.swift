...
public struct PresentationResourcesItemList {
    ...
    public static func block2DestructiveIcon(_ theme: PresentationTheme) -> UIImage? {
        return theme.image(PresentationResourceKey.itemListBlockDestructiveIcon.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Item List/Block2"), color: theme.list.itemDestructiveColor)
        })
    }
