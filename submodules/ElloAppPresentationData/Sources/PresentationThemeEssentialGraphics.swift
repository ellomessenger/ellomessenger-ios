...
public final class PrincipalThemeEssentialGraphics {
    ...
    public let chatMessageBackgroundIncomingFailedImage: UIImage
    ...
    public let chatMessageBackgroundOutgoingFailedImage: UIImage
    ...
    public let radialFailedIndicatiorFileIconIncoming: UIImage
    public let radialFailedIndicatiorFileIconOutgoing: UIImage
    ...
    init(presentationTheme: PresentationTheme, wallpaper initialWallpaper: ElloAppWallpaper, preview: Bool = false, bubbleCorners: PresentationChatBubbleCorners) {
        ...
        if preview {
            ...
            self.chatMessageBackgroundIncomingFailedImage = messageBubbleImage(maxCornerRadius: maxCornerRadius, minCornerRadius: minCornerRadius, incoming: true, fillColor: incoming.failedFill, strokeColor: outgoing.stroke, neighbors: .none, theme: theme, wallpaper: wallpaper, knockout: outgoingKnockout, extendedEdges: true)
            
            self.chatMessageBackgroundOutgoingFailedImage = messageBubbleImage(maxCornerRadius: maxCornerRadius, minCornerRadius: minCornerRadius, incoming: false, fillColor: outgoing.failedFill, strokeColor: outgoing.stroke, neighbors: .none, theme: theme, wallpaper: wallpaper, knockout: outgoingKnockout, extendedEdges: true)
            ...
            self.radialFailedIndicatiorFileIconIncoming = emptyImage
            self.radialFailedIndicatiorFileIconOutgoing = emptyImage
            ...
            self.radialIndicatorFileIconIncoming = generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileLoadDoneIcon"), color: .black)!
            self.radialIndicatorFileIconOutgoing = generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileLoadDoneIcon"), color: .black)!
            
            self.radialFailedIndicatiorFileIconIncoming = generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileLoadFailedIcon"), color: .black)!
            self.radialFailedIndicatiorFileIconOutgoing = generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileLoadFailedIcon"), color: .black)!
...
public final class PrincipalThemeAdditionalGraphics {
    ...
    init(_ theme: PresentationThemeChat, wallpaper: ElloAppWallpaper, bubbleCorners: PresentationChatBubbleCorners) {
        let serviceColor = serviceMessageColorComponents(chatTheme: theme, wallpaper: wallpaper)
