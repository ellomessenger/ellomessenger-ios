...
open class TextNode: ASDisplayNode {
    ...
    static func calculateLayout(attributedString: NSAttributedString?, 
                                ...
                                displayEmbeddedItemsUnderSpoilers: Bool) -> TextNodeLayout {
        if let attributedString = attributedString {
                ...
                if isLastLine {
                    ...
                    if brokenLineRange.location >= 0 && brokenLineRange.length > 0 && brokenLineRange.location + brokenLineRange.length <= attributedString.length {
                        attributedString.enumerateAttributes(in: NSMakeRange(brokenLineRange.location, brokenLineRange.length), options: []) { attributes, range, _ in
                            if attributes[NSAttributedString.Key(rawValue: "ElloAppSpoiler")] != nil || attributes[NSAttributedString.Key(rawValue: "Attribute__Spoiler")] != nil {
                            ...
                            if let embeddedItem = (attributes[NSAttributedString.Key(rawValue: "ElloAppEmbeddedItem")] as? AnyHashable ?? attributes[NSAttributedString.Key(rawValue: "Attribute__EmbeddedItem")] as? AnyHashable) {
                                if displayEmbeddedItemsUnderSpoilers || (attributes[NSAttributedString.Key(rawValue: "ElloAppSpoiler")] == nil && attributes[NSAttributedString.Key(rawValue: "Attribute__Spoiler")] == nil) {
                                    var ascent: CGFloat = 0.0
                                    var descent: CGFloat = 0.0
                                    CTLineGetTypographicBounds(coreTextLine, &ascent, &descent, nil)
            ...
            return TextNodeLayout(attributedString: attributedString, 
    ...
    public static func asyncLayout(_ maybeNode: TextNode?) -> (TextNodeLayoutArguments) -> (TextNodeLayout, () -> TextNode) {
        ...
        return { arguments in
            ...
            var updated = false
            if let existingLayout = existingLayout, existingLayout.constrainedSize == arguments.constrainedSize 
                ...
                if stringMatch {
                    ...
                    layout = TextNode.calculateLayout(attributedString: arguments.attributedString, 
                                                      ...
                                                      lineSpacingFactor: arguments.lineSpacing,
                                                      cutout: arguments.cutout,
                                                      insets: arguments.insets,
                                                      lineColor: arguments.lineColor,
                                                      textShadowColor: arguments.textShadowColor,
                                                      textStroke: arguments.textStroke,
                                                      displaySpoilers: arguments.displaySpoilers,
