...
//        let boldFont = title == nil ? Font.bold(theme.baseFontSize * 13.0 / 17.0) : Font.semibold(floor(theme.baseFontSize * 13.0 / 17.0))
        let font = Font.regular(floor(theme.baseFontSize * 16.0 / 17.0))
        let boldFont = Font.semibold(floor(theme.baseFontSize * 16.0 / 17.0))
        ...
        attributedText = NSAttributedString(
            string: text,
            font: Font.regular(floor(theme.baseFontSize * 16.0 / 17.0)),
