...
public final class DirectMediaImageCache {
    ...
    private func getProgressiveSize(mediaReference: AnyMediaReference, width: Int, representations: [ElloAppMediaImageRepresentation]) -> (resource: MediaResourceReference, size: Int64)? {
    ...
    private func getResource(message: Message, image: ElloAppMediaImage, width: Int) -> (resource: MediaResourceReference, size: Int64)? {
    ...
    private func getResource(message: Message, file: ElloAppMediaFile, width: Int) -> (resource: MediaResourceReference, size: Int64)? {
