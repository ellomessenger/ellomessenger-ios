            ...
            if item.enabled {
                ...
                for option in item.options {
                    ...
                    switch option.type {
                        ...
                        case .default:
                            color = item.presentationData.theme.list.itemDisclosureActions.ʼdefaultʼ.fillColor
                            textColor = item.presentationData.theme.list.itemDisclosureActions.ʼdefaultʼ.foregroundColor
                    }
