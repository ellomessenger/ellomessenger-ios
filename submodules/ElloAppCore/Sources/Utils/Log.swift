...
private let queue = DispatchQueue(label: "org.elloapp.ElloApp.trace", qos: .utility)
...
public final class Logger {
    private let queue = Queue(name: "org.elloapp.ElloApp.log", qos: .utility)
