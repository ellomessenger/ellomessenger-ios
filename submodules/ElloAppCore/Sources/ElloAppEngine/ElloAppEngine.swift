...
public final class ElloAppEngine {
    ...
    public lazy var aiChatBot: AIChatBot = {
        AIChatBot(account: account)
    }()
...
public final class ElloAppEngineUnauthorized {
...
public enum SomeElloAppEngine {
    case unauthorized(ElloAppEngineUnauthorized)
    case authorized(ElloAppEngine)
}
