...
func _internal_downloadAndApplyLocalization(accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network, languageCode: String) -> Signal<Void, DownloadAndApplyLocalizationError> {
