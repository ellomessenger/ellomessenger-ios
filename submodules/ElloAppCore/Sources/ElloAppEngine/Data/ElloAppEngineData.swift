...
public protocol ElloAppEngineDataItem {
    associatedtype Result
}

public protocol ElloAppEngineMapKeyDataItem {
...
protocol PostboxViewDataItem: ElloAppEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataMap<Item: ElloAppEngineDataItem & ElloAppEngineMapKeyDataItem>: ElloAppEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataList<Item: ElloAppEngineDataItem & ElloAppEngineMapKeyDataItem>: ElloAppEngineDataItem, AnyPostboxViewDataItem {
...
public final class EngineDataOptional<Item: ElloAppEngineDataItem>: ElloAppEngineDataItem, AnyPostboxViewDataItem {
    public typealias Result = Item.Result?
...
public extension ElloAppEngine {
    final class EngineData {
        ...
        public func subscribe<T0: ElloAppEngineDataItem>(_ t0: T0) -> Signal<T0.Result, NoError> {
            return self._subscribe(items: [t0 as! AnyPostboxViewDataItem])
            |> map { results -> T0.Result in
                return results[0] as! T0.Result
            }
        }
        public func get<T0: ElloAppEngineDataItem>(_ t0: T0) -> Signal<T0.Result, NoError> {
            return self.subscribe(t0)
            |> take(1)
        }

        public func subscribe<
            T0: ElloAppEngineDataItem,
            T1: ElloAppEngineDataItem
        >(
            _ t0: T0,
            _ t1: T1
        ) -> Signal<
