...
public extension ElloAppEngine {
    final class Contacts {
        ...
        public func searchRemotePeers(query: String, isRecomended: Bool = false, isNew: Bool = false, isPaid: Bool = false, isCourse: Bool = false, isFree: Bool = false, country: String = "", category: String = "", genre: String = "", page: Int = 0) -> Signal<([FoundPeer], [FoundPeer]), NoError> {
            return _internal_searchPeers(account: self.account, query: query, isRecomended: isRecomended, isNew: isNew, isPaid: isPaid, isCourse: isCourse, isFree: isFree, country: country, category: category, genre: genre, page: page)
        }
