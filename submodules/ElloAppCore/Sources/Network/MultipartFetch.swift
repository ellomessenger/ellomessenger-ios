...
private enum MultipartFetchMasterLocation {
    case generic(Int32, (ElloAppMediaResource, MediaResourceReference?, Data?) -> MultipartFetchGenericLocationResult)
...
private enum MultipartFetchSource {
    ...
    func request(offset: Int64, limit: Int64, tag: MediaResourceFetchTag?, resource: ElloAppMediaResource, resourceReference: FetchResourceReference, fileReference: Data?, continueInBackground: Bool) -> Signal<Data, MultipartFetchDownloadError> {
...
private final class MultipartFetchManager {
    ...
    var resource: ElloAppMediaResource
    ...
    init(resource: ElloAppMediaResource, parameters: MediaResourceFetchParameters?, size: Int64?, intervals: Signal<[(Range<Int64>, MediaBoxFetchPriority)], NoError>, encryptionKey: SecretFileEncryptionKey?, decryptedSize: Int64?, location: MultipartFetchMasterLocation, postbox: Postbox, network: Network, revalidationContext: MediaReferenceRevalidationContext?, partReady: @escaping (Int64, Data) -> Void, reportCompleteSize: @escaping (Int64) -> Void, finishWithError: @escaping (MediaResourceDataFetchError) -> Void, useMainConnection: Bool) {
        ...
        if let info = parameters?.info as? ElloAppCloudMediaResourceFetchInfo {
                ...
                switch error {
                    ...
                    case .revalidateMediaReference:
                        if !strongSelf.revalidatingMediaReference && !strongSelf.revalidatedMediaReference {
                            ...
                            if let info = strongSelf.parameters?.info as? ElloAppCloudMediaResourceFetchInfo, let revalidationContext = strongSelf.revalidationContext {
                                ...
                                |> deliverOn(strongSelf.queue)).start(next: { validationResult in
                                    if let strongSelf = self {
                                        ...
                                        if let validatedResource = validationResult.updatedResource as? ElloAppCloudMediaResourceWithFileReference, let reference = validatedResource.fileReference {
...
public func standaloneMultipartFetch(postbox: Postbox, network: Network, resource: ElloAppMediaResource, datacenterId: Int, size: Int64?, intervals: Signal<[(Range<Int64>, MediaBoxFetchPriority)], NoError>, parameters: MediaResourceFetchParameters?, encryptionKey: SecretFileEncryptionKey? = nil, decryptedSize: Int32? = nil, continueInBackground: Bool = false, useMainConnection: Bool = false) -> Signal<MediaResourceDataFetchResult, MediaResourceDataFetchError> {
...
public func resourceFetchInfo(resource: ElloAppMediaResource) -> MediaResourceFetchInfo? {
    return ElloAppCloudMediaResourceFetchInfo(
...
func multipartFetch(postbox: Postbox, network: Network, mediaReferenceRevalidationContext: MediaReferenceRevalidationContext?, resource: ElloAppMediaResource, datacenterId: Int, size: Int64?, intervals: Signal<[(Range<Int64>, MediaBoxFetchPriority)], NoError>, parameters: MediaResourceFetchParameters?, encryptionKey: SecretFileEncryptionKey? = nil, decryptedSize: Int64? = nil, continueInBackground: Bool = false, useMainConnection: Bool = false) -> Signal<MediaResourceDataFetchResult, MediaResourceDataFetchError> {
        ...
        if let resource = resource as? MediaResourceWithWebFileReference {
            ...
            location = .generic(Int32(datacenterId), { resource, resourceReference, fileReference in
                if let resource = resource as? ElloAppCloudMediaResource {
                    ...
                    guard let info = parameters?.info as? ElloAppCloudMediaResourceFetchInfo else {
                        return .none
                    }
