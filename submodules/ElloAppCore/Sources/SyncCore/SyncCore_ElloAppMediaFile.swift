...
public enum StickerPackReference: PostboxCoding, Hashable, Codable {
...
public struct ElloAppMediaVideoFlags: OptionSet {
    ...
    public static let instantRoundVideo = ElloAppMediaVideoFlags(rawValue: 1 << 0)
    public static let supportsStreaming = ElloAppMediaVideoFlags(rawValue: 1 << 1)
}
...
public enum ElloAppMediaFileAttribute: PostboxCoding {
    ...
    case Animated
    case Video(duration: Int, size: PixelDimensions, flags: ElloAppMediaVideoFlags)
    ...
    public init(decoder: PostboxDecoder) {
        ...
        switch type {
            ...
            case typeAnimated:
                self = .Animated
            case typeVideo:
                self = .Video(duration: Int(decoder.decodeInt32ForKey("du", orElse: 0)), size: PixelDimensions(width: decoder.decodeInt32ForKey("w", orElse: 0), height: decoder.decodeInt32ForKey("h", orElse: 0)), flags: ElloAppMediaVideoFlags(rawValue: decoder.decodeInt32ForKey("f", orElse: 0)))
            case typeAudio:
...
public enum ElloAppMediaFileReference: PostboxCoding, Equatable {
...
public enum ElloAppMediaFileDecodingError: Error {
    case generic
}

public final class ElloAppMediaFile: Media, Hashable, Codable {
    enum CodingKeys: String, CodingKey {
        case data
    }
    
    public final class VideoThumbnail: Hashable, PostboxCoding {
        public let dimensions: PixelDimensions
        public let resource: ElloAppMediaResource
        
        public init(dimensions: PixelDimensions, resource: ElloAppMediaResource) {
    ...
    public let resource: ElloAppMediaResource
    public let previewRepresentations: [ElloAppMediaImageRepresentation]
    public let videoThumbnails: [ElloAppMediaFile.VideoThumbnail]
    ...
    public init(fileId: MediaId, partialReference: PartialMediaReference?, resource: ElloAppMediaResource, previewRepresentations: [ElloAppMediaImageRepresentation], videoThumbnails: [ElloAppMediaFile.VideoThumbnail], immediateThumbnailData: Data?, mimeType: String, size: Int64?, attributes: [ElloAppMediaFileAttribute]) {
        self.fileId = fileId
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.resource = decoder.decodeObjectForKey("r") as? ElloAppMediaResource ?? EmptyMediaResource()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        guard let object = postboxDecoder.decodeRootObject() as? ElloAppMediaFile else {
            throw ElloAppMediaFileDecodingError.generic
        }
    ...
    public var premiumEffect: ElloAppMediaFile.VideoThumbnail? {
    ...
    public func isEqual(to other: Media) -> Bool {
        guard let other = other as? ElloAppMediaFile else {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(partialReference)
        hasher.combine(resource.id)
        hasher.combine(previewRepresentations)
        hasher.combine(immediateThumbnailData)
        hasher.combine(size)
    ...
    public func withUpdatedPartialReference(_ partialReference: PartialMediaReference?) -> ElloAppMediaFile {
        return ElloAppMediaFile(fileId: self.fileId, partialReference: partialReference, resource: self.resource, previewRepresentations: self.previewRepresentations, videoThumbnails: self.videoThumbnails, immediateThumbnailData: self.immediateThumbnailData, mimeType: self.mimeType, size: self.size, attributes: self.attributes)
    }

    public func withUpdatedResource(_ resource: ElloAppMediaResource) -> ElloAppMediaFile {
        return ElloAppMediaFile(fileId: self.fileId, partialReference: self.partialReference, resource: resource, previewRepresentations: self.previewRepresentations, videoThumbnails: self.videoThumbnails, immediateThumbnailData: self.immediateThumbnailData, mimeType: self.mimeType, size: self.size, attributes: self.attributes)
    }
    
    public func withUpdatedSize(_ size: Int64?) -> ElloAppMediaFile {
        return ElloAppMediaFile(fileId: self.fileId, partialReference: self.partialReference, resource: self.resource, previewRepresentations: self.previewRepresentations, videoThumbnails: self.videoThumbnails, immediateThumbnailData: self.immediateThumbnailData, mimeType: self.mimeType, size: size, attributes: self.attributes)
    }
    
    public func withUpdatedPreviewRepresentations(_ previewRepresentations: [ElloAppMediaImageRepresentation]) -> ElloAppMediaFile {
        return ElloAppMediaFile(fileId: self.fileId, partialReference: self.partialReference, resource: self.resource, previewRepresentations: previewRepresentations, videoThumbnails: self.videoThumbnails, immediateThumbnailData: self.immediateThumbnailData, mimeType: self.mimeType, size: self.size, attributes: self.attributes)
    }
    
    public func withUpdatedAttributes(_ attributes: [ElloAppMediaFileAttribute]) -> ElloAppMediaFile {
        return ElloAppMediaFile(fileId: self.fileId, partialReference: self.partialReference, resource: self.resource, previewRepresentations: self.previewRepresentations, videoThumbnails: self.videoThumbnails, immediateThumbnailData: self.immediateThumbnailData, mimeType: self.mimeType, size: self.size, attributes: attributes)
    }
}

public func ==(lhs: ElloAppMediaFile, rhs: ElloAppMediaFile) -> Bool {
