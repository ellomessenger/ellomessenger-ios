...
public final class ElloAppMediaGame: Media {
    ...
    public init(gameId: Int64, accessHash: Int64, name: String, title: String, description: String, image: ElloAppMediaImage?, file: ElloAppMediaFile?) {
        self.gameId = gameId
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.image = decoder.decodeObjectForKey("p") as? ElloAppMediaImage
        self.file = decoder.decodeObjectForKey("f") as? ElloAppMediaFile
    }
    ...
    public func isEqual(to other: Media) -> Bool {
        guard let other = other as? ElloAppMediaGame else {
            return false
        }
