...
public struct CachedChannelFlags: OptionSet {
    ...
    public static let adult = CachedChannelFlags(rawValue: 1 << 7)
}
...
public final class CachedChannelData: CachedPeerData {
    ...
    public func withUpdatedPhoto(_ photo: ElloAppMediaImage?) -> CachedChannelData {
