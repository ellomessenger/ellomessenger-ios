...
public struct LimitsConfiguration: Codable, Equatable {
    ...
    public static let kInputTextMaxLength: Int32 = 4096
    public static let kInputMediaTextMaxLength: Int32 = 1024
    ...
    public static var defaultValue: LimitsConfiguration {
        return LimitsConfiguration(maxPinnedChatCount: 5, 
                                   maxArchivedPinnedChatCount: 20,
                                   maxGroupMemberCount: 200,
                                   maxSupergroupMemberCount: 200000,
                                   maxMessageForwardBatchSize: 50,
                                   maxSavedGifCount: 200,
                                   maxRecentStickerCount: 20,
                                   maxFavedStickerCount: 5,
                                   maxMessageEditingInterval: 2 * 24 * 60 * 60,
                                   maxMediaCaptionLength: kInputMediaTextMaxLength,
                                   canRemoveIncomingMessagesInPrivateChats: false,
                                   maxMessageRevokeInterval: 2 * 24 * 60 * 60,
                                   maxMessageRevokeIntervalInPrivateChats: 2 * 24 * 60 * 60)
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.maxMediaCaptionLength = (try? container.decodeIfPresent(Int32.self, forKey: "maxMediaCaptionLength")) ?? 1024
