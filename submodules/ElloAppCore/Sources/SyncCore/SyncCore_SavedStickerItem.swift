...
public final class SavedStickerItem: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.file = ElloAppMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: (try container.decode(AdaptedPostboxDecoder.RawObjectData.self, forKey: "f")).data)))
