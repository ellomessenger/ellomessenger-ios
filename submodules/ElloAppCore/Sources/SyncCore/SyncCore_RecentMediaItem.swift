...
public final class RecentMediaItem: Codable, Equatable {
    public let media: ElloAppMediaFile
    
    public init(_ media: ElloAppMediaFile) {
        self.media = media
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.media = ElloAppMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: mediaData.data)))
    }
...
public final class RecentEmojiItem: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let mediaData = try container.decodeIfPresent(AdaptedPostboxDecoder.RawObjectData.self, forKey: "m") {
            self.content = .file(ElloAppMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: mediaData.data))))
        } else {
...
public final class RecentReactionItem: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let mediaData = try container.decodeIfPresent(AdaptedPostboxDecoder.RawObjectData.self, forKey: "m") {
            self.content = .custom(ElloAppMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: mediaData.data))))
        } else {
