...
public final class StickerPackCollectionInfo: ItemCollectionInfo, Equatable {
    ...
    public let thumbnail: ElloAppMediaImageRepresentation?
    public let thumbnailFileId: Int64?
    public let immediateThumbnailData: Data?
    public let hash: Int32
    public let count: Int32
    
    public init(id: ItemCollectionId, flags: StickerPackCollectionInfoFlags, accessHash: Int64, title: String, shortName: String, thumbnail: ElloAppMediaImageRepresentation?, thumbnailFileId: Int64?, immediateThumbnailData: Data?, hash: Int32, count: Int32) {
        self.id = id
        self.flags = flags
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.thumbnail = decoder.decodeObjectForKey("th", decoder: { ElloAppMediaImageRepresentation(decoder: $0) }) as? ElloAppMediaImageRepresentation
