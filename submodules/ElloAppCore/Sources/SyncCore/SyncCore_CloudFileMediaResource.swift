...
public struct CloudFileMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        return "elloapp-cloud-file-\(self.datacenterId)-\(self.volumeId)-\(self.localId)-\(self.secret)"
    }
}

public final class CloudFileMediaResource: ElloAppMediaResource {
...
public struct CloudPhotoSizeMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        return "elloapp-cloud-photo-size-\(self.datacenterId)-\(self.photoId)-\(self.sizeSpec)"
    }
}

public final class CloudPhotoSizeMediaResource: ElloAppMediaResource {
    public let datacenterId: Int
...
public struct CloudDocumentSizeMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        return "elloapp-cloud-document-size-\(self.datacenterId)-\(self.documentId)-\(self.sizeSpec)"
    }
}

public final class CloudDocumentSizeMediaResource: ElloAppMediaResource {
    public let datacenterId: Int
...
public struct CloudPeerPhotoSizeMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        if let photoId = self.photoId {
            return "elloapp-peer-photo-size-\(self.datacenterId)-\(photoId)-\(self.sizeSpec.rawValue)-\(self.volumeId ?? 0)-\(self.localId ?? 0)"
        } else {
            return "elloapp-peer-photo-size-\(self.datacenterId)-\(self.sizeSpec.rawValue)-\(self.volumeId ?? 0)-\(self.localId ?? 0)"
        }
    }
}

public final class CloudPeerPhotoSizeMediaResource: ElloAppMediaResource {
    public let datacenterId: Int
    public let photoId: Int64?
...
public struct CloudStickerPackThumbnailMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        if let thumbVersion = self.thumbVersion {
            return "elloapp-stickerpackthumbnail-\(self.datacenterId)-\(thumbVersion)-\(self.volumeId ?? 0)-\(self.localId ?? 0)"
        } else {
            return "elloapp-stickerpackthumbnail-\(self.datacenterId)-\(self.volumeId ?? 0)-\(self.localId ?? 0)"
        }
    }
}

public final class CloudStickerPackThumbnailMediaResource: ElloAppMediaResource {
    public let datacenterId: Int
...
public struct CloudDocumentMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        return "elloapp-cloud-document-\(self.datacenterId)-\(self.fileId)"
    }
}

public final class CloudDocumentMediaResource: ElloAppMediaResource {
    public let datacenterId: Int
    public let fileId: Int64
    public let accessHash: Int64
    public let size: Int64?
...
public struct LocalFileMediaResourceId: Hashable, Equatable {
    ...
    public var uniqueId: String {
        return "elloapp-local-file-\(self.fileId)"
    }
}

public class LocalFileMediaResource: ElloAppMediaResource, Codable {
    public let fileId: Int64
    public let size: Int64?
...
public class LocalFileReferenceMediaResource: ElloAppMediaResource {
...
public final class HttpReferenceMediaResource: ElloAppMediaResource {
    public let url: String
    public let size: Int64?
...
protocol MediaResourceWithWebFileReference: ElloAppMediaResource {
    var apiInputLocation: Api.InputWebFileLocation { get }
}

public final class WebFileReferenceMediaResource: ElloAppMediaResource, MediaResourceWithWebFileReference {
    public let url: String
...
final class AlbumCoverResource: ElloAppMediaResource, MediaResourceWithWebFileReference {
...
public final class SecretFileMediaResource: ElloAppMediaResource {
    public let fileId: Int64
    public let accessHash: Int64
    public var size: Int64? {
...
public final class EmptyMediaResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
...
public final class WallpaperDataResource: ElloAppMediaResource {
    public var size: Int64? {
        return nil
    }
