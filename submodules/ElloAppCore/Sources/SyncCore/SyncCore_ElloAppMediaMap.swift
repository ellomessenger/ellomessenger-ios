...
public final class NamedGeoPlace: PostboxCoding, Hashable {
...
public final class MapVenue: PostboxCoding, Hashable {
...
public final class ElloAppMediaMap: Media, Hashable {
    ...
    public func isEqual(to other: Media) -> Bool {
        if let other = other as? ElloAppMediaMap {
    ...
    public static func == (lhs: ElloAppMediaMap, rhs: ElloAppMediaMap) -> Bool {
        lhs.isEqual(to: rhs)
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(geoPlace)
        hasher.combine(venue)
        hasher.combine(liveBroadcastingTimeout)
        hasher.combine(liveProximityNotificationRadius)
    }
}
