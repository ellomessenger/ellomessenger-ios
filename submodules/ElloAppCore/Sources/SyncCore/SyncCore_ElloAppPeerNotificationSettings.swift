...
public final class ElloAppPeerNotificationSettings: PeerNotificationSettings, Equatable {
    ...
    public static var defaultSettings: ElloAppPeerNotificationSettings {
        return ElloAppPeerNotificationSettings(muteState: .unmuted, messageSound: .default, displayPreviews: .default)
    }
    ...
    public func isEqual(to: PeerNotificationSettings) -> Bool {
        if let to = to as? ElloAppPeerNotificationSettings {
            return self == to
        } else {
            return false
        }
    ...
    public func withUpdatedMuteState(_ muteState: PeerMuteState) -> ElloAppPeerNotificationSettings {
        return ElloAppPeerNotificationSettings(muteState: muteState, messageSound: self.messageSound, displayPreviews: self.displayPreviews)
    }
    
    public func withUpdatedMessageSound(_ messageSound: PeerMessageSound) -> ElloAppPeerNotificationSettings {
        return ElloAppPeerNotificationSettings(muteState: self.muteState, messageSound: messageSound, displayPreviews: self.displayPreviews)
    }
    
    public func withUpdatedDisplayPreviews(_ displayPreviews: PeerNotificationDisplayPreviews) -> ElloAppPeerNotificationSettings {
        return ElloAppPeerNotificationSettings(muteState: self.muteState, messageSound: self.messageSound, displayPreviews: displayPreviews)
    }
    
    public static func ==(lhs: ElloAppPeerNotificationSettings, rhs: ElloAppPeerNotificationSettings) -> Bool {
