...
public enum ElloAppBaseTheme: Int32, Codable {
    case classic
    case day
    case night
    case tinted
...
public final class ElloAppThemeSettings: Codable, Equatable {
    public static func == (lhs: ElloAppThemeSettings, rhs: ElloAppThemeSettings) -> Bool {
    ...
    public let baseTheme: ElloAppBaseTheme
    ...
    public init(baseTheme: ElloAppBaseTheme, accentColor: UInt32, outgoingAccentColor: UInt32?, messageColors: [UInt32], animateMessageColors: Bool, wallpaper: ElloAppWallpaper?) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.baseTheme = ElloAppBaseTheme(rawValue: try container.decode(Int32.self, forKey: "baseTheme")) ?? .classic
        ...
        self.wallpaper = (try container.decodeIfPresent(ElloAppWallpaperNativeCodable.self, forKey: "wallpaper"))?.value
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.wallpaper.flatMap(ElloAppWallpaperNativeCodable.init), forKey: "wallpaper")
    }
}

public struct ElloAppThemeNativeCodable: Codable {
    public let value: ElloAppTheme

    public init(_ value: ElloAppTheme) {
        self.value = value
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let fileData = try container.decodeIfPresent(AdaptedPostboxDecoder.RawObjectData.self, forKey: "file") {
            file = ElloAppMediaFile(decoder: PostboxDecoder(buffer: MemoryBuffer(data: fileData.data)))
        } else {
            file = nil
        }

        let legacySettings = try container.decodeIfPresent(ElloAppThemeSettings.self, forKey: "settings")
        var settings = try container.decodeIfPresent([ElloAppThemeSettings].self, forKey: "settingsArray")
...
public final class ElloAppTheme: Equatable {
    public let id: Int64
    ...
    public init(id: Int64, accessHash: Int64, slug: String, emoticon: String?, title: String, file: ElloAppMediaFile?, settings: [ElloAppThemeSettings]?, isCreator: Bool, isDefault: Bool, installCount: Int32?) {
        self.id = id
    ...
    public static func ==(lhs: ElloAppTheme, rhs: ElloAppTheme) -> Bool {
        if lhs.id != rhs.id {
            return false
        }
