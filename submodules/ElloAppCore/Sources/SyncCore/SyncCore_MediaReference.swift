...
public struct WebpageReference: PostboxCoding, Hashable, Equatable {
    ...
    public init(_ webPage: ElloAppMediaWebpage) {
...
public enum PartialMediaReference: Hashable {
...
public typealias FileMediaReference = MediaReference<ElloAppMediaFile>
public typealias ImageMediaReference = MediaReference<ElloAppMediaImage>
