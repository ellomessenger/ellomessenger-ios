...
public struct ChannelParticipantAdminInfo: PostboxCoding, Equatable {
    public let rights: ElloAppChatAdminRights
    public let promotedBy: PeerId
    public let canBeEditedByAccountPeer: Bool
    
    public init(rights: ElloAppChatAdminRights, promotedBy: PeerId, canBeEditedByAccountPeer: Bool) {
        self.rights = rights
    ...
    public init(decoder: PostboxDecoder) {
        self.rights = decoder.decodeObjectForKey("r", decoder: { ElloAppChatAdminRights(decoder: $0) }) as! ElloAppChatAdminRights
...
public struct ChannelParticipantBannedInfo: PostboxCoding, Equatable {
    public let rights: ElloAppChatBannedRights
    public let restrictedBy: PeerId
    public let timestamp: Int32
    public let isMember: Bool
    
    public init(rights: ElloAppChatBannedRights, restrictedBy: PeerId, timestamp: Int32, isMember: Bool) {
        self.rights = rights
    ...
    public init(decoder: PostboxDecoder) {
        self.rights = decoder.decodeObjectForKey("r", decoder: { ElloAppChatBannedRights(decoder: $0) }) as! ElloAppChatBannedRights
