...
public enum ElloAppAccountRecordAttribute: AccountRecordAttribute, Equatable {
    ...
    public func isEqual(to: AccountRecordAttribute) -> Bool {
        return self == to as? ElloAppAccountRecordAttribute
    }
}

public final class ElloAppAccountManagerTypes: AccountManagerTypes {
    public typealias Attribute = ElloAppAccountRecordAttribute
}
...
private var declaredEncodables: Void = {
    ...
    declareEncodable(ElloAppUser.self, f: { ElloAppUser(decoder: $0) })
    declareEncodable(ElloAppGroup.self, f: { ElloAppGroup(decoder: $0) })
    declareEncodable(ElloAppChannel.self, f: { ElloAppChannel(decoder: $0) })
    declareEncodable(ElloAppMediaImage.self, f: { ElloAppMediaImage(decoder: $0) })
    declareEncodable(ElloAppMediaImageRepresentation.self, f: { ElloAppMediaImageRepresentation(decoder: $0) })
    declareEncodable(ElloAppMediaContact.self, f: { ElloAppMediaContact(decoder: $0) })
    declareEncodable(ElloAppMediaMap.self, f: { ElloAppMediaMap(decoder: $0) })
    declareEncodable(ElloAppMediaFile.self, f: { ElloAppMediaFile(decoder: $0) })
    declareEncodable(ElloAppMediaFileAttribute.self, f: { ElloAppMediaFileAttribute(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaWebpage.self, f: { ElloAppMediaWebpage(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaAction.self, f: { ElloAppMediaAction(decoder: $0) })
    declareEncodable(ElloAppPeerNotificationSettings.self, f: { ElloAppPeerNotificationSettings(decoder: $0) })
    ...
    declareEncodable(ElloAppUserPresence.self, f: { ElloAppUserPresence(decoder: $0) })
    ...
    declareEncodable(ElloAppSecretChat.self, f: { ElloAppSecretChat(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaGame.self, f: { ElloAppMediaGame(decoder: $0) })
    declareEncodable(ElloAppMediaInvoice.self, f: { ElloAppMediaInvoice(decoder: $0) })
    declareEncodable(ElloAppMediaWebFile.self, f: { ElloAppMediaWebFile(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaExpiredContent.self, f: { ElloAppMediaExpiredContent(decoder: $0) })
    ...
    declareEncodable(ElloAppDeviceContactImportedData.self, f: { ElloAppDeviceContactImportedData(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaPoll.self, f: { ElloAppMediaPoll(decoder: $0) })
    declareEncodable(ElloAppMediaUnsupported.self, f: { ElloAppMediaUnsupported(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaWebpageAttribute.self, f: { ElloAppMediaWebpageAttribute(decoder: $0) })
    declareEncodable(ElloAppMediaDice.self, f: { ElloAppMediaDice(decoder: $0) })
    ...
    declareEncodable(ElloAppMediaFile.VideoThumbnail.self, f: { ElloAppMediaFile.VideoThumbnail(decoder: $0) })
    declareEncodable(PeerAccessRestrictionInfo.self, f: { PeerAccessRestrictionInfo(decoder: $0) })
    declareEncodable(ElloAppMediaImage.VideoRepresentation.self, f: { ElloAppMediaImage.VideoRepresentation(decoder: $0) })
    ...
    declareEncodable(ElloAppExtendedMedia.self, f: { ElloAppExtendedMedia(decoder: $0) })
    return
}()
...
public func rootPathForBasePath(_ appGroupPath: String) -> String {
    return appGroupPath + "/elloapp-data"
}
...
public func currentAccount(allocateIfNotExists: Bool, networkArguments: NetworkInitializationArguments, supplementary: Bool, manager: AccountManager<ElloAppAccountManagerTypes>, rootPath: String, auxiliaryMethods: AccountAuxiliaryMethods, encryptionParameters: ValueBoxEncryptionParameters) -> Signal<AccountResult?, NoError> {
...
public func logoutFromAccount(id: AccountRecordId, accountManager: AccountManager<ElloAppAccountManagerTypes>, alreadyLoggedOutRemotely: Bool) -> Signal<Void, NoError> {
        ...
        transaction.updateRecord(id, { current in
            if alreadyLoggedOutRemotely {
                ...
                if found {
                    ...
                    return AccountRecord(id: current.id, 
                                         attributes: current.attributes + [.loggedOut(LoggedOutAccountAttribute())],
...
public func managedCleanupAccounts(networkArguments: NetworkInitializationArguments, accountManager: AccountManager<ElloAppAccountManagerTypes>, rootPath: String, auxiliaryMethods: AccountAuxiliaryMethods, encryptionParameters: ValueBoxEncryptionParameters) -> Signal<Void, NoError> {
    ...
    return Signal { subscriber in
        ...
        let disposable = accountManager.accountRecords().start(next: { view in
            ...
            var beginList: [(AccountRecordId, [ElloAppAccountManagerTypes.Attribute], MetaDisposable)] = []
            let _ = loggedOutAccounts.modify { disposables in
                var validIds: [AccountRecordId: [ElloAppAccountManagerTypes.Attribute]] = [:]
...
private func cleanupAccount(networkArguments: NetworkInitializationArguments, accountManager: AccountManager<ElloAppAccountManagerTypes>, id: AccountRecordId, encryptionParameters: ValueBoxEncryptionParameters, attributes: [ElloAppAccountManagerTypes.Attribute], rootPath: String, auxiliaryMethods: AccountAuxiliaryMethods) -> Signal<Void, NoError> {
