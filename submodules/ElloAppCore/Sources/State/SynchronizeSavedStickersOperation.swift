...
public func addSavedSticker(postbox: Postbox, network: Network, file: ElloAppMediaFile, limit: Int = 5) -> Signal<Void, AddSavedStickerError> {
...
public func addSavedSticker(transaction: Transaction, file: ElloAppMediaFile, stringRepresentations: [String], limit: Int = 5) {
