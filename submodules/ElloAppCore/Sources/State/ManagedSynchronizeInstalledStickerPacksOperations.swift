...
func debugFetchAllStickers(account: Account) -> Signal<Never, NoError> {
    ...
    let stickerItems: Signal<[ElloAppMediaFile], NoError> = account.postbox.itemCollectionsView(orderedItemListCollectionIds: orderedItemListCollectionIds, namespaces: namespaces, aroundIndex: nil, count: 10000000)
