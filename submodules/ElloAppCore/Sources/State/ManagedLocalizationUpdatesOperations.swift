...
func managedLocalizationUpdatesOperations(accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network) -> Signal<Void, NoError> {
    return Signal { _ in
...
func getLocalization(_ transaction: AccountManagerModifier<ElloAppAccountManagerTypes>) -> (primary: (code: String, version: Int32, entries: [LocalizationEntry]), secondary: (code: String, version: Int32, entries: [LocalizationEntry])?) {
...
private func synchronizeLocalizationUpdates(accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network) -> Signal<Void, NoError> {
...
func tryApplyingLanguageDifference(transaction: AccountManagerModifier<ElloAppAccountManagerTypes>, langCode: String, difference: Api.LangPackDifference) -> Bool {
    let (primary, secondary) = getLocalization(transaction)
    switch difference {
