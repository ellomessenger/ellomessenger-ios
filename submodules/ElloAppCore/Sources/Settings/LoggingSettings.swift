...
public func updateLoggingSettings(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (LoggingSettings) -> LoggingSettings) -> Signal<Void, NoError> {
