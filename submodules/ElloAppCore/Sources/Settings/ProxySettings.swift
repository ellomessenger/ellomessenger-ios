...
public func updateProxySettingsInteractively(accountManager: AccountManager<ElloAppAccountManagerTypes>, _ f: @escaping (ProxySettings) -> ProxySettings) -> Signal<Bool, NoError> {
...
public func updateProxySettingsInteractively(transaction: AccountManagerModifier<ElloAppAccountManagerTypes>, _ f: @escaping (ProxySettings) -> ProxySettings) -> Bool {
