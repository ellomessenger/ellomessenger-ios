...
public final class ContactsSearchContainerNode: SearchDisplayControllerContentNode {
    ...
    public init(context: AccountContext, 
        ...
        self.addSubnode(self.emptyResultsAnimationNode)// TODO: Need update animation sticker
        ...
        self.searchDisposable.set((searchItems |> deliverOnMainQueue).start(next: { [weak self] items, query in
            if let strongSelf = self {
                ...
                let transition = contactListSearchContainerPreparedRecentTransition(from: previousItems, 
                                                                                    to: items ?? [],
                                                                                    isSearching: items != nil,
                                                                                    emptyResults: items?.isEmpty ?? false,
                                                                                    query: query,
                                                                                    context: context,
                                                                                    presentationData: strongSelf.presentationData,
                                                                                    nameSortOrder: strongSelf.presentationData.nameSortOrder,
                                                                                    nameDisplayOrder: strongSelf.presentationData.nameDisplayOrder,
                                                                                    timeFormat: strongSelf.presentationData.dateTimeFormat,
    ...
    override public func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        self.listNode.transaction(deleteIndices: [], 
                                  ...
                                  options: [.Synchronous],
                                  scrollToItem: nil,
                                  updateSizeAndInsets: ListViewUpdateSizeAndInsets(size: layout.size,
                                                                                   insets: UIEdgeInsets(top: topInset,
