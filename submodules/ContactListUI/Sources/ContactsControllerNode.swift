...
//        }
    ...
    func activateSearch(placeholderNode: SearchBarPlaceholderNode) {
        ...
        self.searchDisplayController = SearchDisplayController(presentationData: self.presentationData, 
                                                               contentNode: ContactsSearchContainerNode(context: self.context,
                                                                                                        onlyWriteable: false,
                                                                                                        categories: [
                                                                                                            .cloudContacts,
                                                                                                            .global,
                                                                                                            // .deviceContacts  //EM-3125
                                                                                                        ],
