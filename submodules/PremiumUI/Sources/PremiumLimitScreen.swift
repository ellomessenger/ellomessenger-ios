...
private class PremiumLimitAnimationComponent: Component {
    ...
    final class View: UIView {
        ...
        override init(frame: CGRect) {
            ...
            self.badgeCountLabel.font = Font.with(size: 20.0, design: .round, weight: .medium, traits: [])
        ...
        func update(component: PremiumLimitAnimationComponent, availableSize: CGSize, transition: Transition) -> CGSize {
            ...
            self.badgeIcon.frame = CGRect(x: 18.0, y: 12.0, width: 24.0, height: 24.0)
            self.badgeCountLabel.frame = CGRect(x: badgeSize.width - countWidth - 11.0, y: 18.0, width: countWidth, height: 24.0)
            ...
            if self.previousAvailableSize != availableSize {
                ...
                let gradient = generateGradientImage(size: CGSize(width: 200.0, height: 56.0), colors: component.activeColors, locations: locations, direction: .horizontal)
...
public final class PremiumLimitDisplayComponent: CombinedComponent {
    ...
    public static var body: Body {
        ...
        return { context in
            ...
            context.add(animation.position(CGPoint(x: context.availableSize.width / 2.0, y: height / 2.0)))
    ...
    static var body: Body {
        ...
        return { context in
            ...
            if state.initialized {
                ...
                let markdownAttributes = MarkdownAttributes(body: MarkdownAttributeSet(font: textFont, textColor: textColor), 
                ...
                if isPremiumDisabled {
                    gradientColors = [
                        UIColor(rgb: 0x6CA5F9),
                        UIColor(rgb: 0x3A85F3)
                    ]
                } else {
                    gradientColors = [
                ...
                let button = button.update(
                    component: SolidRoundedButtonComponent(
                        ...
                        theme: SolidRoundedButtonComponent.Theme(
                            backgroundColor: UIColor(rgb: 0xA49A5),     // .black
                            backgroundColors: [UIColor(rgb: 0xA49A5)],  // gradientColors
                ...
                contentSize = CGSize(width: context.availableSize.width, height: 295.0) // + environment.safeInsets.bottom)
            }
...
public class PremiumLimitScreen: ViewControllerComponentContainer {
    ...
    public init(context: AccountContext, 
                subject: PremiumLimitScreen.Subject,
                count: Int32,
                action: @escaping () -> Void) {
        super.init(context: context, 
                   component: LimitSheetComponent(context: context, subject: subject, count: count, action: action),
