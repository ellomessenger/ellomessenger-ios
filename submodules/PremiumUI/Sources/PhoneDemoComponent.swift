...
private final class PhoneView: UIView {
    ...
    func setup(context: AccountContext, videoFile: ElloAppMediaFile?, position: PhoneDemoComponent.Position) {
