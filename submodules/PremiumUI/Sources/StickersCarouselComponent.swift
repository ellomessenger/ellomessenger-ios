...
final class StickersCarouselComponent: Component {
    ...
    let stickers: [ElloAppMediaFile]
    
    public init(
        context: AccountContext,
        stickers: [ElloAppMediaFile]
    ) {
...
private class StickerNode: ASDisplayNode {
    ...
    init(context: AccountContext, file: ElloAppMediaFile, forceIsPremium: Bool) {
        self.context = context
        self.file = file
...
private class StickersCarouselNode: ASDisplayNode, UIScrollViewDelegate {
    private let context: AccountContext
    private let stickers: [ElloAppMediaFile]
    ...
    init(context: AccountContext, stickers: [ElloAppMediaFile]) {
        self.context = context
        self.stickers = stickers
