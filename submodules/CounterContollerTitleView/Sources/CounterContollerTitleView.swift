...
public final class CounterContollerTitleView: UIView {
    ...
    private func update() {
        self.titleNode.attributedText = NSAttributedString(string: self.title.title, font: Font.semibold(16.0), textColor: self.theme.rootController.navigationBar.primaryTextColor)
        self.subtitleNode.attributedText = NSAttributedString(string: self.title.counter, font: Font.regular(12.0), textColor: self.theme.rootController.navigationBar.secondaryTextColor)
