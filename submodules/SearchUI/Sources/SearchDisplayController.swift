...
public final class SearchDisplayController {
    ...
    public init(presentationData: PresentationData, 
        ...
        self.inline = inline
        self.searchBar = SearchBarNode(theme: SearchBarNodeTheme(theme: presentationData.theme, 
    ...
    public func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        self.searchBar.updateLayout(boundingSize: searchBarFrame.size,
        ...
        self.contentNode.containerLayoutUpdated(ContainerViewLayout(size: size, 
