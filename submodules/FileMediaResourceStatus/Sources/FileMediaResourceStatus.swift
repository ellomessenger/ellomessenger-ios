...
private func internalMessageFileMediaPlaybackStatus(context: AccountContext, file: ElloAppMediaFile, message: Message, isRecentActions: Bool, isGlobalSearch: Bool, isDownloadList: Bool) -> Signal<MediaPlayerStatus?, NoError> {
...
public func messageFileMediaPlaybackStatus(context: AccountContext, file: ElloAppMediaFile, message: Message, isRecentActions: Bool, isGlobalSearch: Bool, isDownloadList: Bool) -> Signal<MediaPlayerStatus, NoError> {
    var duration = 0.0
...
public func messageFileMediaPlaybackAudioLevelEvents(context: AccountContext, file: ElloAppMediaFile, message: Message, isRecentActions: Bool, isGlobalSearch: Bool, isDownloadList: Bool) -> Signal<Float, NoError> {
    guard let playerType = peerMessageMediaPlayerType(message) else {
        return .never()
    }
...
public func messageFileMediaResourceStatus(context: AccountContext, file: ElloAppMediaFile, message: Message, isRecentActions: Bool, isSharedMedia: Bool = false, isGlobalSearch: Bool = false, isDownloadList: Bool = false) -> Signal<FileMediaResourceStatus, NoError> {
...
public func messageImageMediaResourceStatus(context: AccountContext, image: ElloAppMediaImage, message: Message, isRecentActions: Bool, isSharedMedia: Bool = false, isGlobalSearch: Bool = false) -> Signal<FileMediaResourceStatus, NoError> {
    if message.flags.isSending {
