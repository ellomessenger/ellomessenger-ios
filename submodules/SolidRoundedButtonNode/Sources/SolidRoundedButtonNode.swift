...
public final class SolidRoundedButtonNode: ASDisplayNode {
    ...
    public init(title: String? = nil,
        ...
        if theme.backgroundColors.count > 1 {
            ...
            self.buttonBackgroundNode.image = generateGradientImage(size: CGSize(width: width, height: height), colors: theme.backgroundColors, locations: locations, direction: .horizontal)
            
            let buttonBackgroundAnimationView = UIImageView()
            buttonBackgroundAnimationView.image = generateGradientImage(size: CGSize(width: width, height: height),
