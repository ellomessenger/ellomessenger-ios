...
final class JoinLinkPreviewControllerNode: ViewControllerTracingNode, UIScrollViewDelegate {
    ...
    func setInvitePeer(image: ElloAppMediaImageRepresentation?, title: String, memberCount: Int32, members: [EnginePeer], data: JoinLinkPreviewData) {
    ...
    func setRequestPeer(image: ElloAppMediaImageRepresentation?, title: String, about: String?, memberCount: Int32, isGroup: Bool) {
