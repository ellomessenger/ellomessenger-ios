...
public struct SecretApi46 {
    public static func parse(_ buffer: Buffer) -> Any? {
        ...
        fileprivate static func parse(_ reader: BufferReader, signature: Int32) -> Any? {
            if let parser = parsers[signature] {
                ...
                elloappApiLog("Type constructor \(String(signature, radix: 16, uppercase: false)) not found")
                return nil
            }
        }
    ...
    public enum DecryptedMessageMedia {
        ...
        case decryptedMessageMediaContact(username: String, firstName: String, lastName: String, userId: Int32)
    ...
    switch self {
        ...
        fileprivate static func parse_decryptedMessageMediaContact(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c4 = _4 != nil
            if _c1 && _c2 && _c3 && _c4 {
                return SecretApi46.DecryptedMessageMedia.decryptedMessageMediaContact(username: _1!, firstName: _2!, lastName: _3!, userId: _4!)
            }
            else {
                return nil
            }
