...
public extension Api {
    indirect enum InputMedia: TypeConstructorDescription {
        case inputMediaContact(username: String, firstName: String, lastName: String, vcard: String, userid: Int64)
    ...
    public func serialize(_ buffer: Buffer, _ boxed: Swift.Bool) {
    switch self {
                case .inputMediaContact(let phoneNumber, let firstName, let lastName, let vcard, let userid):
                    if boxed {
    ...
    public func descriptionFields() -> (String, [(String, Any)]) {
        switch self {
                case .inputMediaContact(let phoneNumber, let firstName, let lastName, let vcard, let userid):
                return ("inputMediaContact", [("phoneNumber", String(describing: phoneNumber)), ("firstName", String(describing: firstName)), ("lastName", String(describing: lastName)), ("vcard", String(describing: vcard)), ("userid", String(describing: userid))])
                case .inputMediaDice(let emoticon):
        ...
        public static func parse_inputMediaContact(_ reader: BufferReader) -> InputMedia? {
            ...
            if _c1 && _c2 && _c3 && _c4 && userid != nil {
                return Api.InputMedia.inputMediaContact(username: _1!, firstName: _2!, lastName: _3!, vcard: _4!, userid: userid!)
            }
            else {
                return nil
            }
