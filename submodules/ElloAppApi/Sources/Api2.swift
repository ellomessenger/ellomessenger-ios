public extension Api {
    enum BotInlineMessage: TypeConstructorDescription {
        ...
        case botInlineMessageMediaContact(flags: Int32, username: String, firstName: String, lastName: String, vcard: String, replyMarkup: Api.ReplyMarkup?)
    ...
    public func descriptionFields() -> (String, [(String, Any)]) {
        ...
        public static func parse_botInlineMessageMediaContact(_ reader: BufferReader) -> BotInlineMessage? {
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 {
                return Api.BotInlineMessage.botInlineMessageMediaContact(flags: _1!, username: _2!, firstName: _3!, lastName: _4!, vcard: _5!, replyMarkup: _6)
            }
            else {
                return nil
            }
