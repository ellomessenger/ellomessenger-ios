...
public extension Api {
    indirect enum MessageMedia: TypeConstructorDescription {
        case messageMediaContact(username: String, firstName: String, lastName: String, vcard: String, userId: Int64)
    ...
    public func descriptionFields() -> (String, [(String, Any)]) {
        ...
        public static func parse_messageMediaContact(_ reader: BufferReader) -> MessageMedia? {
            ...
            let _c5 = _5 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return Api.MessageMedia.messageMediaContact(username: _1!, firstName: _2!, lastName: _3!, vcard: _4!, userId: _5!)
            }
            else {
                return nil
            }
