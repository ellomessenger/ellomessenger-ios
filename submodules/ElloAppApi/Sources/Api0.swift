...
public enum Api {
    ...
    public enum sendVerifyCode {}
    public enum deleteAccount {}
    public enum updateProfile {}
    public enum wallet {}
    public enum ai {}
    public enum paidSubscription {}
...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[-1634294960] = { return Api.ChatInvite.parse_chatInviteUser ($0) }
    ...
    dict[1001001002] = { return Api.Feeds.parse_historyMessages($0) }
    return dict
}()
