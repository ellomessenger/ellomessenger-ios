...
public extension Api.functions.account {
    static func updateProfile(flags: Int32, firstName: String?, lastName: String?, about: String?, birthday: Date?, country: String?, gender: String?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.User>) {
        let buffer = Buffer()
        ...
        if Int(flags) & Int(1 << 24) != 0 {serializeString(country!, buffer: buffer, boxed: false)}
        if Int(flags) & Int(1 << 25) != 0 {serializeString(gender!, buffer: buffer, boxed: false)}
        if Int(flags) & Int(1 << 26) != 0 {serializeInt32(Int32(birthday!.timeIntervalSince1970), buffer: buffer, boxed: false)}
        return (FunctionDescription(name: "account.updateProfile", 
                                    parameters: [("flags", String(describing: flags)),
                                                 ("firstName", String(describing: firstName)),
                                                 ("lastName", String(describing: lastName)),
                                                 ("country", String(describing: country)),
                                                 ("gender", String(describing: gender)),
                                                 ("birthday", String(describing: birthday?.timeIntervalSince1970)),
                                                 ("about", String(describing: about))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.User? in
            let reader = BufferReader(buffer)
            var result: Api.User?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.User
...
public extension Api.functions.channels {
    // if name is empty then channel is private else public
    static func createChannel(flags: Int32,
                              title: String,
                              about: String,
                              ...
                              genre: String?,
                              subGenre: String?,
                              name: String?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        ...
        if Int(flags) & Int(1 << 5) != 0 {
            serializeInt64(startDate!, buffer: buffer, boxed: false)
            serializeInt64(endDate!, buffer: buffer, boxed: false)
        }
        ...
        if Int(flags) & Int(1 << 11) != 0 {
            serializeString(genre!, buffer: buffer, boxed: false)
        }
        if Int(flags) & Int(1 << 12) != 0 {
            serializeString(subGenre!, buffer: buffer, boxed: false)
        }
        if Int(flags) & Int(1 << 13) != 0 {
            serializeString(name!, buffer: buffer, boxed: false)
        }
        
        return (FunctionDescription(name: "channels.createChannel", 
                                    parameters: [("flags", String(describing: flags)),
                                                 ("title", String(describing: title)),
                                                 ("about", String(describing: about)),
                                                 ("geoPoint", String(describing: geoPoint)),
                                                 ...
                                                 ("subGenre", String(describing: subGenre)),
...
public extension Api.functions.contacts {
    static func addContact(flags: Int32, id: Api.InputUser, firstName: String, lastName: String, phone: String) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        ...
        return (FunctionDescription(name: "contacts.addContact", 
                                    parameters: [("flags", String(describing: flags)),
...
public extension Api.functions.contacts {
    static func search(q: String, limit: Int32, isRecomended: Bool, isNew: Bool, isPaid: Bool, isCourse: Bool, isFree: Bool, country: String, category: String, genre: String, page: Int) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.contacts.Found>) {
        let buffer = Buffer()
        buffer.appendInt32(301470424)
        serializeString(q, buffer: buffer, boxed: false)
        serializeInt32(limit, buffer: buffer, boxed: false)
        // New update api https://elloapp.atlassian.net/wiki/spaces/EM/pages/158171139/Recommended+channels
        ...
        serializeInt32(Int32(flags), buffer: buffer, boxed: false)
        ...
        if page != 0 {
            serializeInt32(Int32(page), buffer: buffer, boxed: false)
        }
        
        
        return (FunctionDescription(name: "contacts.search", parameters: [("q", String(describing: q)), ("limit", String(describing: limit)), ("isRecomended", String(describing: isRecomended)), ("isNew", String(describing: isNew)), ("isPaid", String(describing: isPaid)), ("isCourse", String(describing: isCourse)), ("isFree", String(describing: isFree)), ("country", String(describing: country)), ("category", String(describing: category)), ("genre", String(describing: genre)), ("page", String(describing: page))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.contacts.Found? in
            let reader = BufferReader(buffer)
...
public extension Api.functions.messages {
    static func exportChatInvite(flags: Int32, peer: Api.InputPeer, expireDate: Int32?, usageLimit: Int32?, title: String?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.ExportedChatInvite>) {
        ...
        if Int(flags) & Int(1 << 1) != 0 {serializeInt32(usageLimit!, buffer: buffer, boxed: false)}
        if Int(flags) & Int(1 << 4) != 0 {serializeString(title!, buffer: buffer, boxed: false)}
        return (FunctionDescription(name: "messages.exportChatInvite",
                                    parameters: [("flags", String(describing: flags)),
                                                 ("peer", String(describing: peer)),
                                                 ("expireDate", String(describing: expireDate)),
                                                 ("usageLimit", String(describing: usageLimit)),
                                                 ("title", String(describing: title))]),
                buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.ExportedChatInvite? in
            let reader = BufferReader(buffer)
...
public extension Api.functions.messages {
    static func migrateChat(chatId: Int64, showHistory: Api.Bool = .boolTrue) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        buffer.appendInt32(-1568189671)
        serializeInt64(chatId, buffer: buffer, boxed: false)
        showHistory.serialize(buffer, true)
        return (FunctionDescription(name: "messages.migrateChat", parameters: [("chatId", String(describing: chatId)), ("showHistory", String(describing: showHistory))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.Updates? in
            let reader = BufferReader(buffer)
            var result: Api.Updates?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.Updates
...
public extension Api.functions.messages {
    static func search(flags: Int32, peer: Api.InputPeer, q: String, fromId: Api.InputPeer?, topMsgId: Int32?, filter: Api.MessagesFilter, minDate: Int32, maxDate: Int32, offsetId: Int32, addOffset: Int32, limit: Int32, maxId: Int32, minId: Int32, hash: Int64, isPaid: Bool = false) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.Messages>) {
        var flags = flags
        if isPaid {
            flags |= 1 << 2
        }
...
public extension Api.functions.messages {
    static func searchGlobal(flags: Int32, folderId: Int32?, q: String, filter: Api.MessagesFilter, minDate: Int32, maxDate: Int32, offsetRate: Int32, offsetPeer: Api.InputPeer, offsetId: Int32, limit: Int32) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.Messages>) {
        ...
        serializeInt32(offsetId, buffer: buffer, boxed: false)
        serializeInt32(limit, buffer: buffer, boxed: false)
        return (FunctionDescription(name: "messages.searchGlobal", 
                                    parameters: [("flags", String(describing: flags)),
                                                 ("folderId", String(describing: folderId)),
                                                 ("q", String(describing: q)),
                                                 ("filter", String(describing: filter)),
                                                 ("minDate", String(describing: minDate)),
                                                 ("maxDate", String(describing: maxDate)),
                                                 ("offsetRate", String(describing: offsetRate)),
                                                 ("offsetPeer", String(describing: offsetPeer)),
                                                 ("offsetId", String(describing: offsetId)),
...
public extension Api.functions.messages {
    static func sendMultiMedia(flags: Int32, peer: Api.InputPeer, replyToMsgId: Int32?, multiMedia: [Api.InputSingleMedia], scheduleDate: Int32?, sendAs: Api.InputPeer?, title: String? = nil, description: String? = nil, price: Double? = nil, quantity: Int32? = nil) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        ...
        if Int(flags) & Int(1 << 2) != 0 {
            serializeString(title ?? "", buffer: buffer, boxed: true)
            serializeString(description ?? "", buffer: buffer, boxed: true)
            buffer.appendDouble(price ?? 0)
            buffer.appendInt32(quantity ?? 0)
        }
