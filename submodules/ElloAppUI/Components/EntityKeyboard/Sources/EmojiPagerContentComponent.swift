...
public struct EmojiComponentReactionItem {
    ...
    public var file: ElloAppMediaFile
    
    public init(reaction: MessageReaction.Reaction, file: ElloAppMediaFile) {
...
public final class EntityKeyboardAnimationData: Equatable {
    ...
    public convenience init(file: ElloAppMediaFile, isReaction: Bool = false) {
        let type: ItemType
...
private final class EmptySearchResultsView: UIView {
    ...
    func update(context: AccountContext, theme: PresentationTheme, useOpaqueTheme: Bool, text: String, file: ElloAppMediaFile?, size: CGSize, transition: Transition) {
...
public final class EmojiPagerContentComponent: Component {
    ...
    public final class Item: Equatable {
        ...
        public let itemFile: ElloAppMediaFile?
    ...
    public final class EmptySearchResults: Equatable {
        ...
        public let iconFile: ElloAppMediaFile?
        
        public init(text: String, iconFile: ElloAppMediaFile?) {
            self.text = text
    ...
    public static func emojiInputData(
        ...
        var iconStatusEmoji: Signal<[ElloAppMediaFile], NoError> = .single([])
            ...
            if isStatusSelection {
                ...
                if let recentReactions = recentReactions {
                    ...
                    for item in recentReactions.items {
                        ...
                        let animationFile: ElloAppMediaFile
                        let icon: EmojiPagerContentComponent.Item.Icon
