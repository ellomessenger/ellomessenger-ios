...
public final class AudioWaveformComponent: Component {
    ...
    public let gravityMultiplier: GravityMultiplier?
        ...
        override public func draw(_ rect: CGRect) {
            ...
            component.samples.withUnsafeBytes { rawSamples -> Void in
                ...
                for i in 0 ..< numSamples {
                    ...
                    var gravityMultiplierY: CGFloat = 1
                    switch component.gravityMultiplier ?? .bottom {
                    case .bottom:
                        gravityMultiplierY = 1
                    case .center:
