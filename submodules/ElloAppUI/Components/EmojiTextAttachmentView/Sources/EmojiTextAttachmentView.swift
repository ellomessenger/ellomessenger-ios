...
public final class InlineStickerItemLayer: MultiAnimationRenderTarget {
    ...
    public private(set) var file: ElloAppMediaFile?
    ...
    public init(context: AccountContext, attemptSynchronousLoad: Bool, emoji: ChatTextInputTextCustomEmojiAttribute, file: ElloAppMediaFile?, cache: AnimationCache, renderer: MultiAnimationRenderer, unique: Bool = false, placeholderColor: UIColor, pointSize: CGSize, loopCount: Int? = nil) {
    ...
    private func updateFile(file: ElloAppMediaFile, attemptSynchronousLoad: Bool) {
...
public final class EmojiTextAttachmentView: UIView {
    ...
    public init(context: AccountContext, emoji: ChatTextInputTextCustomEmojiAttribute, file: ElloAppMediaFile?, cache: AnimationCache, renderer: MultiAnimationRenderer, placeholderColor: UIColor, pointSize: CGSize) {
