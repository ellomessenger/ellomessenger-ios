...
extension FeedContentMapItem: Hashable {
    static func == (lhs: FeedContentMapItem, rhs: FeedContentMapItem) -> Bool {
...
//    func arguments(completionHandler: @escaping (FeedMessageInteractiveFileNode.Arguments) -> Void) {
//        guard let messageId = message.messageId else {
//            return
//        }
//        
...
//            }
//            
//            let arguments = FeedMessageInteractiveFileNode.Arguments(
