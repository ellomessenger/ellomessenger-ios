...
private struct EmojisChatInputContextPanelEntry: Comparable, Identifiable {
    ...
    func item(context: AccountContext, animationCache: AnimationCache, animationRenderer: MultiAnimationRenderer, emojiSelected: @escaping (String, ElloAppMediaFile?) -> Void) -> ListViewItem {
...
private func preparedTransition(from fromEntries: [EmojisChatInputContextPanelEntry], to toEntries: [EmojisChatInputContextPanelEntry], context: AccountContext, animationCache: AnimationCache, animationRenderer: MultiAnimationRenderer, emojiSelected: @escaping (String, ElloAppMediaFile?) -> Void) -> EmojisChatInputContextPanelTransition {
...
final class EmojisChatInputContextPanelNode: ChatInputContextPanelNode {
    ...
    func updateResults(_ results: [(String, ElloAppMediaFile?, String)]) {
