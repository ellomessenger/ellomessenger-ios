...
final class DocumentPreviewController: UINavigationController, QLPreviewControllerDelegate, QLPreviewControllerDataSource {
    ...
    private let file: ElloAppMediaFile
    
    private var item: DocumentPreviewItem?
    
    private var tempFile: TempBoxFile?
    
    init(theme: PresentationTheme, strings: PresentationStrings, postbox: Postbox, file: ElloAppMediaFile) {
...
final class CompactDocumentPreviewController: QLPreviewController, QLPreviewControllerDelegate, QLPreviewControllerDataSource {
    ...
    init(theme: PresentationTheme, strings: PresentationStrings, postbox: Postbox, file: ElloAppMediaFile, canShare: Bool = true) {
        self.postbox = postbox
        self.file = file
...
func presentDocumentPreviewController(rootController: UIViewController, theme: PresentationTheme, strings: PresentationStrings, postbox: Postbox, file: ElloAppMediaFile, canShare: Bool) {
