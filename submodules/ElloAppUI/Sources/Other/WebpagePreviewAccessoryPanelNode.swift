...
final class WebpagePreviewAccessoryPanelNode: AccessoryPanelNode {
    ...
    private(set) var webpage: ElloAppMediaWebpage
    ...
    init(context: AccountContext, url: String, webpage: ElloAppMediaWebpage, theme: PresentationTheme, strings: PresentationStrings) {
        self.url = url
    ...
    func replaceWebpage(url: String, webpage: ElloAppMediaWebpage) {
