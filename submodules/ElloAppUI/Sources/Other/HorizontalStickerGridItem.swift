...
final class HorizontalStickerGridItem: GridItem {
    ...
    init(account: Account, file: ElloAppMediaFile, theme: PresentationTheme, isPreviewed: @escaping (HorizontalStickerGridItem) -> Bool, sendSticker: @escaping (FileMediaReference, UIView, CGRect) -> Void) {
