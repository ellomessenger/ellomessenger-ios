...
final class LockView: UIButton, TGModernConversationInputMicButtonLock {
    ...
    func updateTheme(_ theme: PresentationTheme) {
        ...
        [
            ...
            "Rectangle.Rectangle.Обводка 1": theme.chat.inputPanel.panelControlLockButtonStartAnimateColor,
            "Path.Path.Обводка 1": theme.chat.inputPanel.panelControlLockButtonStartAnimateColor,
            "Path 4.Path 4.Обводка 1": theme.chat.inputPanel.panelControlLockButtonStartAnimateColor
        ...
        [
            "Path.Path.Обводка 1": theme.chat.inputPanel.panelControlLockButtonEndAnimateColor,
            "Path.Path.Заливка 1": theme.chat.inputPanel.panelBackgroundColor,
            "Rectangle.Rectangle.Обводка 1": theme.chat.inputPanel.panelControlLockButtonEndAnimateColor,
            "Rectangle.Заливка 1": theme.chat.inputPanel.panelControlLockButtonEndAnimateColor,
            "Path 4.Path 4.Обводка 1": theme.chat.inputPanel.panelControlLockButtonEndAnimateColor
        ].forEach { key, value in
