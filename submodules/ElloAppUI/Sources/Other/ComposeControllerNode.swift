...
final class ComposeControllerNode: ASDisplayNode {
    ...
    var openCreateNewOnlineCourse: (() -> Void)?
    ...
    init(context: AccountContext) {
        ...
        // Working ADDUser functionality just close for oner request 1
//        var openCreateContactImpl: (() -> Void)?
        var openCreateNewChannelImpl: (() -> Void)?
        var openCreateNewOnlineCourseImpl: (() -> Void)?
        ...
        self.contactListNode = ContactListNode(context: context, presentation: .single(.natural(options: [
            ...
            // Working ADDUser functionality just close for oner request 2
...
//            }),
            ...
            ContactListAdditionalOption(title: self.presentationData.strings.Compose_NewOnlineCourse, icon: .generic(UIImage(bundleImageName: "Contact List/CreateOnlineCourseActionIcon")!), action: {
                openCreateNewOnlineCourseImpl?()
            })
        ...
        // Working ADDUser functionality just close for oner request 3
...
//        }
        ...
        openCreateNewOnlineCourseImpl = { [weak self] in
            self?.openCreateNewOnlineCourse?()
        }
