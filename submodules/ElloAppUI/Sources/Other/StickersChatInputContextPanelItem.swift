...
final class StickersChatInputContextPanelItem: ListViewItem {
    ...
    public init(account: Account, theme: PresentationTheme, index: Int, files: [ElloAppMediaFile], itemsInRow: Int, stickersInteraction: StickersChatInputContextPanelInteraction, interfaceInteraction: ChatPanelInterfaceInteraction) {
