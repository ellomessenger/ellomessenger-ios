...
public final class LargeEmojiActionSheetItem: ActionSheetItem {
    ...
    public init(context: AccountContext, text: String, fitz: String?, file: ElloAppMediaFile) {
...
private final class LargeEmojiActionSheetItemNode: ActionSheetItemNode {
    ...
    init(theme: ActionSheetControllerTheme, context: AccountContext, text: String, fitz: String?, file: ElloAppMediaFile) {
        self.theme = theme
