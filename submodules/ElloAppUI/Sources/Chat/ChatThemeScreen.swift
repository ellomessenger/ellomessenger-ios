...
private class ThemeSettingsThemeIconItem: ListViewItem {
    ...
    public init(context: AccountContext, emoticon: String?, emojiFile: ElloAppMediaFile?, themeReference: PresentationThemeReference?, nightMode: Bool, selected: Bool, theme: PresentationTheme, strings: PresentationStrings, wallpaper: ElloAppWallpaper?, action: @escaping (String?) -> Void) {
