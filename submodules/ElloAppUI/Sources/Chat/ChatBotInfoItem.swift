...
final class ChatBotInfoItem: ListViewItem {
    ...
    fileprivate let photo: ElloAppMediaImage?
    fileprivate let video: ElloAppMediaFile?
    ...
    init(title: String, text: String, photo: ElloAppMediaImage?, video: ElloAppMediaFile?, controllerInteraction: ChatControllerInteraction, presentationData: ChatPresentationData, context: AccountContext) {
        self.title = title
        self.text = text
        self.photo = photo
        self.video = video
...
final class ChatBotInfoItemNode: ListViewItemNode {
    ...
    private func setup(context: AccountContext, videoFile: ElloAppMediaFile?) {
