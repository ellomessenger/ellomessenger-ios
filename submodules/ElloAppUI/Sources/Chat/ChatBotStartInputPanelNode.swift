...
final class ChatBotStartInputPanelNode: ChatInputPanelNode {
    ...
    init(theme: PresentationTheme, strings: PresentationStrings) {
        ...
        self.button.setAttributedTitle(NSAttributedString(string: strings.Bot_Start, font: Font.regular(17.0), textColor: theme.chat.inputPanel.panelControlTextColor), for: [])
    ...
    func updateThemeAndStrings(theme: PresentationTheme, strings: PresentationStrings) {
        if self.theme !== theme || self.strings !== strings {
            self.theme = theme
            self.strings = strings
            self.backgroundColor = theme.chat.inputPanel.panelControlTextColor
