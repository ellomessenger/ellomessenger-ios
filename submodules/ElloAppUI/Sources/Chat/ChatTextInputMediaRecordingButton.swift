...
final class ChatTextInputMediaRecordingButton: TGModernConversationInputMicButton, TGModernConversationInputMicButtonDelegate {
    ...
    private func updateAnimation(previousMode: ChatTextInputMediaRecordingButtonMode) {
        ...
        case .video:
            ...
            image = PresentationResourcesChat.chatInputPanelVoiceButtonImage(self.theme)
        case .settings:
            self.icon = PresentationResourcesChat.chatInputPanelSettingsActiveButtonImage(self.theme)
            image = PresentationResourcesChat.chatInputPanelSettingsActiveButtonImage(self.theme)
        }
        ...
        switch self.mode {
            case .audio:
                animationName = "anim_videoToMic_new"
            case .video:
                animationName = "anim_micToVideo_new"
            case .settings:
                animationName = "settings_ai"
        }
        ...
        for colorKey in colorKeys {
            colors[colorKey] = self.theme.chat.inputPanel.mediaRecordingControl.activeIconColor
        }
