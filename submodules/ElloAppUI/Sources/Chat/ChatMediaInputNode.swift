...
final class ChatMediaInputNode: ChatInputNode {
    ...
    init(context: AccountContext, peerId: PeerId?, chatLocation: ChatLocation?, controllerInteraction: ChatControllerInteraction, chatWallpaper: ElloAppWallpaper, theme: PresentationTheme, strings: PresentationStrings, fontSize: PresentationFontSize, gifPaneIsActiveUpdated: @escaping (Bool) -> Void) {
        ...
        self.inputNodeInteraction = ChatMediaInputNodeInteraction(navigateToCollectionId: { [weak self] collectionId in
            ...
            let _ = (context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.StickerPack(id: peerId))
    ...
    private func updateThemeAndStrings(chatWallpaper: ElloAppWallpaper, theme: PresentationTheme, strings: PresentationStrings) {
                        ...
                        if let pane = pane as? ChatMediaInputGifPane {
                            ...
                            if let (itemNode, item) = itemNodeAndItem {
                                ...
                                return combineLatest(
                                    ...
                                    strongSelf.context.engine.data.get(ElloAppEngine.EngineData.Item.Peer.Peer(id: accountPeerId)) |> map { peer -> Bool in
