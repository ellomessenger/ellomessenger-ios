    ...
    switch inputQuery {
        ...
        case let .emojiSearch(query, languageCode, range):
            if query.isSingleEmoji {
                ...
                |> map { view, hasPremium -> [(String, ElloAppMediaFile?, String)] in
...
func urlPreviewStateForInputText(_ inputText: NSAttributedString?, context: AccountContext, currentQuery: String?) -> (String?, Signal<(ElloAppMediaWebpage?) -> ElloAppMediaWebpage?, NoError>)? {
