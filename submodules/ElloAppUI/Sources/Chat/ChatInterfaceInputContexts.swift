...
func inputTextPanelStateForChatPresentationInterfaceState(_ chatPresentationInterfaceState: ChatPresentationInterfaceState, context: AccountContext) -> ChatTextInputPanelState {
    ...
    if let peer = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppSecretChat {
    ...
    } else if let group = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppGroup {
    ...
    } else if let user = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppUser {
        if user.botInfo == nil {
            canSetupAutoremoveTimeout = true
        }
    } else if let channel = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppChannel {
    ...
    if canSetupAutoremoveTimeout {
        if case .scheduledMessages = chatPresentationInterfaceState.subject {
            ...
            if currentAutoremoveTimeout != nil || chatPresentationInterfaceState.renderedPeer?.peer is ElloAppSecretChat {
    ...
    switch chatPresentationInterfaceState.inputMode {
        case .media:
            ...
            return ChatTextInputPanelState(accessoryItems: accessoryItems, 
                                           contextPlaceholder: contextPlaceholder, 
                                           mediaRecordingState: chatPresentationInterfaceState.inputTextPanelState.mediaRecordingState)
        case .inputButtons:
            return ChatTextInputPanelState(accessoryItems: [.botInput(isEnabled: true, inputMode: .keyboard)], 
                                           contextPlaceholder: contextPlaceholder,
                                           mediaRecordingState: chatPresentationInterfaceState.inputTextPanelState.mediaRecordingState)
        case .none, .text:
            if let _ = chatPresentationInterfaceState.interfaceState.editMessage {
                ...
                if !extendedSearchLayout {
                    if case .scheduledMessages = chatPresentationInterfaceState.subject {
                        ...
                        if let peer = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppSecretChat, chatPresentationInterfaceState.interfaceState.composeInputState.inputText.length == 0 {
                ...
                if chatPresentationInterfaceState.interfaceState.forwardMessageIds == nil {
                    ...
                    if let peer = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppChannel {
                    ...
                    } else if let peer = chatPresentationInterfaceState.renderedPeer?.peer as? ElloAppGroup {
