...
public final class ChatControllerInteraction {
    ...
    let displayPollSolution: (ElloAppMediaPollResults.Solution, ASDisplayNode) -> Void
    let displayPsa: (String, ASDisplayNode) -> Void
    let displayDiceTooltip: (ElloAppMediaDice) -> Void
    let animateDiceSuccess: (Bool, Bool) -> Void
    let displayPremiumStickerTooltip: (ElloAppMediaFile, Message) -> Void
    ...
    let commitEmojiInteraction: (MessageId, String, EmojiInteraction, ElloAppMediaFile) -> Void
    let openLargeEmojiInfo: (String, String?, ElloAppMediaFile) -> Void
    ...
    init(
        ...
        displayPollSolution: @escaping (ElloAppMediaPollResults.Solution, ASDisplayNode) -> Void,
        displayPsa: @escaping (String, ASDisplayNode) -> Void,
        displayDiceTooltip: @escaping (ElloAppMediaDice) -> Void,
        animateDiceSuccess: @escaping (Bool, Bool) -> Void,
        displayPremiumStickerTooltip: @escaping (ElloAppMediaFile, Message) -> Void,
        ...
        commitEmojiInteraction: @escaping (MessageId, String, EmojiInteraction, ElloAppMediaFile) -> Void,
        openLargeEmojiInfo: @escaping (String, String?, ElloAppMediaFile) -> Void,
