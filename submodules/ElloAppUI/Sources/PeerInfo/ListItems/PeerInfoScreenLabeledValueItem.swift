...
private final class PeerInfoScreenLabeledValueItemNode: PeerInfoScreenItemNode {
    ...
    override func update(width: CGFloat, safeInsets: UIEdgeInsets, presentationData: PresentationData, item: PeerInfoScreenItem, topItem: PeerInfoScreenItem?, bottomItem: PeerInfoScreenItem?, hasCorners: Bool, transition: ContainedViewLayoutTransition) -> CGFloat {
        ...
        self.expandNode.attributedText = NSAttributedString(string: presentationData.strings.PeerInfo_BioExpand, font: Font.regular(15.0), textColor: presentationData.theme.list.itemAccentColor)
        let expandSize = self.expandNode.updateLayout(CGSize(width: width, height: 100.0))
        
        self.labelNode.attributedText = NSAttributedString(string: item.label, font: Font.regular(12.0), textColor: presentationData.theme.list.textGrayLabelColor)
        ...
        case .singleLine:
            ...
            self.textNode.attributedText = NSAttributedString(string: item.text, font: Font.regular(15.0), textColor: textColorValue)
        ...
        case let .multiLine(maxLines, enabledEntities):
            ...
            func createAttributedText(_ text: String) -> NSAttributedString {
                if enabledEntities.isEmpty {
                    return NSAttributedString(string: text, font: Font.regular(15.0), textColor: textColorValue)
                } else {
                    let fontSize: CGFloat = 15.0
