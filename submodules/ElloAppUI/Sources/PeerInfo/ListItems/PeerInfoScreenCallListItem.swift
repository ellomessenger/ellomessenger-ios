...
private final class PeerInfoScreenCallListItemNode: PeerInfoScreenItemNode {
    ...
    override func update(width: CGFloat, 
        ...
        self.maskNode.image = hasCorners ? PresentationResourcesItemList.cornersImage(presentationData.theme, 
                                                                                      top: nil == topItem,
                                                                                      bottom: nil == bottomItem) : nil
        self.maskNode.frame = CGRect(origin: CGPoint(x: safeInsets.left, y: 0.0),
                                     size: CGSize(width: width - safeInsets.left - safeInsets.right, height: height))
