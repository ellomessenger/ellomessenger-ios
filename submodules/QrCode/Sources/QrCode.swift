...
//            gradient.color0 = CIColor(color: .blue)
//            gradient.color1 = CIColor(color: .red)
//            gradient.point0 = CGPoint(x: 0, y: 100)
//            gradient.point1 = CGPoint(x: 200, y: 100)
    ...
    |> map { data, size, bytesPerRow in
        return (size, { arguments in
            ...
            let fittedRect = CGRect(origin: CGPoint(x: drawingRect.origin.x + (drawingRect.size.width - fittedSize.width) / 2.0, 
            ...
            context.withContext { c in
                ...
                case let .custom(image):
                    if let image = image {
                        ...
                        let fittedRect = CGRect(origin: CGPoint(x: fittedRect.midX - fittedSize.width / 2.0, 
                                                                y: fittedRect.midY - fittedSize.height / 2.0),
                                                size: fittedSize)
...
private extension UIImage {
     ...
     */
    func imageWithGradient(from beginColor: UIColor, to endColor: UIColor, with frame: CGRect) -> UIImage? {
