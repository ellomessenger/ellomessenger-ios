...
- (instancetype)initWithDelegate:(id<TGVideoCameraPipelineDelegate>)delegate position:(AVCaptureDevicePosition)position callbackQueue:(dispatch_queue_t)queue liveUploadInterface:(id<TGLiveUploadInterface>)liveUploadInterface
{
	...
	if (self != nil)
	{
		...
		_videoDataOutputQueue = dispatch_queue_create("org.elloapp.VideoCameraPipeline.video", DISPATCH_QUEUE_SERIAL);
...
- (void)setupCaptureSession
{
	...
	_audioDataOutputQueue = dispatch_queue_create("org.elloapp.VideoCameraPipeline.audio", DISPATCH_QUEUE_SERIAL);
...
- (void)startRecording:(NSURL *)url preset:(TGMediaVideoConversionPreset)preset liveUpload:(bool)liveUpload
{
	...
	dispatch_queue_t callbackQueue = dispatch_queue_create("org.elloapp.VideoCameraPipeline.recorder", DISPATCH_QUEUE_SERIAL);
