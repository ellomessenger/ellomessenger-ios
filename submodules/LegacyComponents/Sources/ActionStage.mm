...
static const char *graphQueueSpecific = "com.elloph.graphdispatchqueue";
...
- (dispatch_queue_t)globalStageDispatchQueue
{
    ...
    {
        mainGraphQueue = dispatch_queue_create("com.elloph.graphdispatchqueue", 0);
        
        globalGraphQueue = dispatch_queue_create("com.elloph.graphdispatchqueue-global", 0);
        dispatch_set_target_queue(globalGraphQueue, mainGraphQueue);
        
        highPriorityGraphQueue = dispatch_queue_create("com.elloph.graphdispatchqueue-high", 0);
