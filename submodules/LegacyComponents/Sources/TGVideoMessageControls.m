...
//            [self addSubview:_slideToCancelArrow];
            ...
            _cancelButton.titleLabel.font = TGSemiboldSystemFontOfSize(16.0f);
...
//            setViewFrame(_cancelButton, CGRectMake(CGFloor((self.frame.size.width - _cancelButton.frame.size.width) / 2.0f), CGFloor((self.frame.size.height - _cancelButton.frame.size.height) / 2.0f) - 1.0f, _cancelButton.frame.size.width, _cancelButton.frame.size.height));
            setViewFrame(_cancelButton, CGRectMake(CGFloor((self.frame.size.width + _cancelButton.frame.size.width) / 2.0f + 12.0f), CGFloor((self.frame.size.height - _cancelButton.frame.size.height) / 2.0f + 2.0f), _cancelButton.frame.size.width, _cancelButton.frame.size.height));
        }
