...
open class LegacyController: ViewController, PresentableController, AttachmentContainable {
    ...
    override open func viewWillAppear(_ animated: Bool) {
        ...
        self.legacyController.beginAppearanceTransition(true, animated: animated && passControllerAppearanceAnimated(in: true, presentation: self.presentation))
    }
    ...
    override open func viewWillDisappear(_ animated: Bool) {
        ...
        self.legacyController.beginAppearanceTransition(false, animated: animated && passControllerAppearanceAnimated(in: false, presentation: self.presentation))
    }
    ...
    private func viewDidAppear(animated: Bool, completion: @escaping () -> Void) {
        ...
        switch self.presentation {
            case let .modal(animateIn):
                ...
                self.legacyController.endAppearanceTransition()
    ...
    override open func containerLayoutUpdated(_ layout: ContainerViewLayout, transition: ContainedViewLayoutTransition) {
        ...
        if let legacyElloAppController = self.legacyController as? TGViewController {
            ...
            legacyElloAppController.intrinsicSize = size
            legacyElloAppController._updateInset(for: orientation, force: false, notify: true)
            if self.enableContainerLayoutUpdates {
                legacyElloAppController.layoutController(for: size, duration: duration)
            }
        }
...
//        controllerNode.removeFromSupernode()
    }
