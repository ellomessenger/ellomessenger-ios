...
#if DEBUG
                    NSLog(@"message: %@: \ndata: %@: transactionId: %@ \nauthInfoSelector:%lld",incomingMessage, [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding], transactionId, authInfoSelector );
#endif
                    [self _processIncomingMessage:incomingMessage 
