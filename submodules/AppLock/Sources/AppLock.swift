...
public final class AppLockContextImpl: AppLockContext {
    ...
    private let applicationBindings: ElloAppApplicationBindings
    ...
    public init(rootPath: String, window: Window1?, rootController: UIViewController?, applicationBindings: ElloAppApplicationBindings, accountManager: AccountManager<ElloAppAccountManagerTypes>, presentationDataSignal: Signal<PresentationData, NoError>, lockIconInitialFrame: @escaping () -> CGRect?) {
