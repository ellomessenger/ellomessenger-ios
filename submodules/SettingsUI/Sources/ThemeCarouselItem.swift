...
private struct ThemeCarouselThemeEntry: Comparable, Identifiable {
    ...
    let themeSpecificChatWallpapers: [Int64: ElloAppWallpaper]
    var selected: Bool
...
class ThemeCarouselThemeIconItem: ListViewItem {
    ...
    public init(context: AccountContext, emojiFile: ElloAppMediaFile?, themeReference: PresentationThemeReference, nightMode: Bool, themeSpecificAccentColors: [Int64: PresentationThemeAccentColor], themeSpecificChatWallpapers: [Int64: ElloAppWallpaper], selected: Bool, theme: PresentationTheme, strings: PresentationStrings, wallpaper: ElloAppWallpaper?, action: @escaping (PresentationThemeReference) -> Void, contextAction: ((PresentationThemeReference, ASDisplayNode, ContextGesture?) -> Void)?) {
...
class ThemeCarouselThemeItem: ListViewItem, ItemListItem {
    ...
    init(context: AccountContext, theme: PresentationTheme, strings: PresentationStrings, sectionId: ItemListSectionId, themes: [PresentationThemeReference], animatedEmojiStickers: [String: [StickerPackItem]], themeSpecificAccentColors: [Int64: PresentationThemeAccentColor], themeSpecificChatWallpapers: [Int64: ElloAppWallpaper], nightMode: Bool, currentTheme: PresentationThemeReference, updatedTheme: @escaping (PresentationThemeReference) -> Void, contextAction: ((PresentationThemeReference, ASDisplayNode, ContextGesture?) -> Void)?, tag: ItemListItemTag? = nil) {
        self.context = context
        self.theme = theme
        self.strings = strings
        self.themes = themes
