...
private enum QuickReactionSetupControllerEntry: ItemListNodeEntry {
    ...
    case demoMessage(wallpaper: ElloAppWallpaper, fontSize: PresentationFontSize, bubbleCorners: PresentationChatBubbleCorners, dateTimeFormat: PresentationDateTimeFormat, nameDisplayOrder: PresentationPersonNameOrder, availableReactions: AvailableReactions?, reaction: MessageReaction.Reaction?)
