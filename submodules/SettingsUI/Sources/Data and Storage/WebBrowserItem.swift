...
class WebBrowserItem: ListViewItem, ItemListItem {
    ...
    public init(engine: ElloAppEngine, presentationData: ItemListPresentationData, title: String, application: OpenInApplication, checked: Bool, sectionId: ItemListSectionId, action: @escaping () -> Void) {
        self.engine = engine
