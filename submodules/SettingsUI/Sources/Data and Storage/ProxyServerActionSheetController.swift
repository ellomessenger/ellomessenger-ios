...
public final class ProxyServerActionSheetController: ActionSheetController {
    ...
    public init(presentationData: PresentationData, accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network, server: ProxyServerSettings, updatedPresentationData: Signal<PresentationData, NoError>?) {
...
private final class ProxyServerActionItem: ActionSheetItem {
    ...
    init(accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network, presentationData: PresentationData, server: ProxyServerSettings, dismiss: @escaping (Bool) -> Void, present: @escaping (ViewController, Any?) -> Void) {
...
private final class ProxyServerActionItemNode: ActionSheetItemNode {
    ...
    init(accountManager: AccountManager<ElloAppAccountManagerTypes>, postbox: Postbox, network: Network, presentationData: PresentationData, theme: ActionSheetControllerTheme, server: ProxyServerSettings, dismiss: @escaping (Bool) -> Void, present: @escaping (ViewController, Any?) -> Void) {
        self.accountManager = accountManager
        self.postbox = postbox
        self.network = network
        self.theme = theme
