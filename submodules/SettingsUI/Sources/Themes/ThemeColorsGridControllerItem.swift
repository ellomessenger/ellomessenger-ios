...
final class ThemeColorsGridControllerItem: GridItem {
    ...
    init(context: AccountContext, wallpaper: ElloAppWallpaper, selected: Bool, interaction: ThemeColorsGridControllerInteraction) {
...
final class ThemeColorsGridControllerItemNode: GridItemNode {
    ...
    private var currentState: (AccountContext, ElloAppWallpaper, Bool)?
    ...
    func setup(context: AccountContext, wallpaper: ElloAppWallpaper, selected: Bool, interaction: ThemeColorsGridControllerInteraction) {
        self.interaction = interaction
