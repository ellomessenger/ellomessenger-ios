...
final class ThemeGridControllerItem: GridItem {
    ...
    init(context: AccountContext, wallpaper: ElloAppWallpaper, wallpaperId: ThemeGridControllerEntry.StableId, index: Int, editable: Bool, selected: Bool, interaction: ThemeGridControllerInteraction) {
