...
private class ThemeSettingsThemeIconItem: ListViewItem {
    ...
    public init(context: AccountContext, themeReference: PresentationThemeReference, accentColor: PresentationThemeAccentColor?, selected: Bool, title: String, theme: PresentationTheme, wallpaper: ElloAppWallpaper?, action: @escaping (PresentationThemeReference) -> Void, contextAction: ((PresentationThemeReference, ASDisplayNode, ContextGesture?) -> Void)?) {
            ...
            return (layout, { [weak self] in
                if let strongSelf = self {
                    ...
                    for theme in item.themes {
                        ...
                        var themeWallpaper: ElloAppWallpaper?
                        if case let .cloud(theme) = theme {
