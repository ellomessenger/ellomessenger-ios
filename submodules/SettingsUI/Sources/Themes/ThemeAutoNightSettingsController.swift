...
private enum ThemeAutoNightSettingsControllerEntry: ItemListNodeEntry {
    ...
    case themeItem(PresentationTheme, PresentationStrings, [PresentationThemeReference], [PresentationThemeReference], PresentationThemeReference, [Int64: PresentationThemeAccentColor], [Int64: ElloAppWallpaper])
...
public func themeAutoNightSettingsController(context: AccountContext) -> ViewController {
    ...
    |> map { presentationData, sharedData, cloudThemes, stagingSettings -> (ItemListControllerState, (ItemListNodeState, Any)) in
        ...
        let defaultThemes: [PresentationThemeReference] = [.builtin(.day), .builtin(.dayClassic)]//[.builtin(.night), .builtin(.nightAccent)]
