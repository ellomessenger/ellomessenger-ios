...
private func patternWallpaper(data: BuiltinWallpaperData, colors: [UInt32], intensity: Int32?, rotation: Int32?) -> ElloAppWallpaper {
...
var dayClassicColorPresets: [PresentationThemeAccentColor] = [
    // Ello Blue
    PresentationThemeAccentColor(index: 101, baseColor: .preset, accentColor: 0x0A49A5, bubbleColors: [0x0A49A5, 0x4a85da], wallpaper: patternWallpaper(data: .variant3, colors: [0x164180, 0x2d486f, 0x29589c, 0x2f4565], intensity: 50, rotation: nil)),
...
var dayColorPresets: [PresentationThemeAccentColor] = [
    PresentationThemeAccentColor(index: 101, baseColor: .preset, accentColor: 0x0A49A5, bubbleColors: [0x0A49A5, 0x508ae0], wallpaper: nil),
